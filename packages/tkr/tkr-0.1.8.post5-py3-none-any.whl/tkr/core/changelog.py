...
### Added
```diff
+ tkr.ext.tests.Driver: Pull code or file contents from toolkitr/tkr/test folder.
```

### Examples

Upgrading to V0.1.7.9
`pip install --upgrade`
or Install tkr
...
driver: tests.Driver = tests.Driver('key.py') # Defaults to README.md which provides info on the latest testing files.
print(driver)
```
