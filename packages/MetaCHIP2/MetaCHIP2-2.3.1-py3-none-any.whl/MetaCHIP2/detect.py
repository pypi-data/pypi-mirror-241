...
def Get_circlize_plot(multi_level_detection, pwd_candidates_file_PG_normal_txt, genome_to_taxon_dict, circos_HGT_R, pwd_plot_circos, taxon_rank, pwd_MetaCHIP_op_folder):
    ...
    pwd_cir_plot_t1                 = '%s/HGTs_among_%s_tmp1.txt'               % (pwd_MetaCHIP_op_folder, rank_abbre_dict[taxon_rank])
    pwd_cir_plot_t1_sorted          = '%s/HGTs_among_%s_tmp1_sorted.txt'        % (pwd_MetaCHIP_op_folder, rank_abbre_dict[taxon_rank])
    pwd_cir_plot_t1_sorted_count    = '%s/HGTs_among_%s_tmp1_sorted_count.txt'  % (pwd_MetaCHIP_op_folder, rank_abbre_dict[taxon_rank])
    pwd_cir_plot_matrix_filename    = '%s/HGTs_among_%s_tmp.txt'                % (pwd_MetaCHIP_op_folder, rank_abbre_dict[taxon_rank])
    pwd_cir_plot_matrix_filename_t  = '%s/HGTs_among_%s.txt'                    % (pwd_MetaCHIP_op_folder, rank_abbre_dict[taxon_rank])
...
def Get_circlize_plot_customized_grouping(multi_level_detection, pwd_candidates_file_PG_normal_txt, genome_to_group_dict, circos_HGT_R, pwd_plot_circos, pwd_MetaCHIP_op_folder):
    ...
    pwd_cir_plot_t1                 = '%s/cir_plot_tmp1.txt'                % pwd_MetaCHIP_op_folder
    pwd_cir_plot_t1_sorted          = '%s/cir_plot_tmp1_sorted.txt'         % pwd_MetaCHIP_op_folder
    pwd_cir_plot_t1_sorted_count    = '%s/cir_plot_tmp1_sorted_count.txt'   % pwd_MetaCHIP_op_folder
    pwd_cir_plot_matrix_filename    = '%s/cir_plot_matrix_tmp.txt'          % pwd_MetaCHIP_op_folder
    pwd_cir_plot_matrix_filename_t  = '%s/cir_plot_matrix.txt'              % pwd_MetaCHIP_op_folder
