...
reporting_period_paths = {
    ...
    "2019BC": ANNUAL_WRA_PATH / "Backcalc_2019_2014-18" / "Code",
    "2018BC": ANNUAL_WRA_PATH / "Backcalc_2018_2013-17" / "Code",
    "2017BC": ANNUAL_WRA_PATH / "Backcalc_2017_2012-16" / "Code",
    "2016BC": ANNUAL_WRA_PATH / "Backcalc_2016_2011-15" / "Code",
    "2015BC": ANNUAL_WRA_PATH / "Backcalc_2015_2010-14" / "Code",
    "2014BC": ANNUAL_WRA_PATH / "Backcalc_2014_2009-13" / "Code",
    "2013BC": ANNUAL_WRA_PATH / "Backcalc_2013_2008-12" / "Code",
    "2012BC": ANNUAL_WRA_PATH / "Backcalc_2012_2007-11" / "Code",
    "2011BC": ANNUAL_WRA_PATH / "Backcalc_2011_2006-10" / "Code",
}
...
def create_index_pages_for_all_reporting_periods(style=INDEX_PAGE_STYLE):
    ...
    for rp_key, path in rp_keys.items():
        print(f"Creating HTML index pages for reporting period {rp_key}")
    ...
    rp_key_table["rp_key"] = rp_key_table.apply(
        lambda x: f'<a href="file:///{str(Path(x.path).parent / "index.html")}">{x.rp_key}</a>',
        axis=1,
    )
...
class ReportingPeriod:
    ...
    def __init__(self, path):
        ...
        self.path = Path(path)
        logger.debug(f"reporting period: {self.path}")
        self.dfs_cache = {}
