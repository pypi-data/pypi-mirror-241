...
class Callback:
    ...
    def on_after_train_batch(self, trainer, metrics, model_out, batch_idx):
        """
        Args:
            trainer:   Trainer
            metrics:   当前batch的训练指标值字典
            model_out: 当前batch模型的预测输出
    ...
    def on_after_val_batch(self, trainer, metrics, model_out, batch_idx):
        """
        Args:
            trainer:   Trainer
            metrics:   当前验证batch的指标值字典
            model_out: 当前验证batch模型的预测输出
            batch_idx: 当前验证batch index
        """
    ...
    def on_after_test_batch(self, trainer, metrics, model_out, batch_idx):
        """
        Args:
            trainer:   Trainer
            metrics:   当前测试batch的指标值字典
            model_out: 当前测试batch模型的预测输出
            batch_idx: 当前测试batch index
        """
