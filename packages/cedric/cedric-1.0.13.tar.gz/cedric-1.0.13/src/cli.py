...
def create_django_app(app_name):
    ...
    # serializers.py
    with open("./authentication/api/serializers.py", "r") as serializers_file:
    ...
    # views.py
    with open("./authentication/api/views.py", "r")  as views_file:
    ...
    # urls.py
    with open("./authentication/urls.py", "r") as urls_file:
    ...
    # utils.py
    with open("./authentication/utils.py", "r") as utils_file:
        utils_file_content = utils_file.read()
        with open(os.path.join(app_path, "authentication", "utils.py"), "a+") as new_utils_file:
            new_utils_file.write(utils_content)
