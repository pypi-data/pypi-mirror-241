...
def create_django_app(app_name):
    ...
    install_app_path = _post_install()

    print(install_app_path)
    # models.py
    with open(os.path.join("./authentication/models.py"), "r") as models_file:
    ...
    # urls.py
    with open(os.path.join("./authentication/urls.py"), "r") as urls_file:
