...
def create_django_app(app_name):
    ...
    # models.py
    with open(
        "src/authentication/models.py", "r"
    ) as models_file:
    ...
    # serializers.py
    with open(
        os.path.join("src/authentication/api/serializers.py"), "r"
    ) as serializers_file:
    ...
    # views.py
    with open(
        os.path.join("src/authentication/api/views.py"), "r"
    ) as views_file:
    ...
    # urls.py
    with open(
        os.path.join("src/authentication/urls.py"), "r"
    ) as urls_file:
