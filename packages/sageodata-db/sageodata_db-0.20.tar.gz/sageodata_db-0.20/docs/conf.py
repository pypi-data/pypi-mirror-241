...
intersphinx_mapping = {
    ...
    # "sageodata_db": (
    #     "file:///P:/projects_gw/State/Groundwater_Toolbox/Python/wheels/docs/sageodata_db/latest_github",
    #     "sageodata_db.objects.inv",
    # ),
    "dew_gwdata": (
        "file:///P:/projects_gw/State/Groundwater_Toolbox/Python/wheels/docs/dew_gwdata/latest_github",
        "dew_gwdata.objects.inv",
    ),
    "wrap_technote": (
        "file:///P:/projects_gw/State/Groundwater_Toolbox/Python/wheels/docs/wrap_technote/latest_github",
        "wrap_technote.objects.inv",
    ),
    "waterkennect": (
        "file:///P:/projects_gw/State/Groundwater_Toolbox/Python/wheels/docs/waterkennect/latest_github",
