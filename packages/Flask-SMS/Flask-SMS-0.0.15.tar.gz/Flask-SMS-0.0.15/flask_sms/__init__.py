...
class SMS(object):
    ...
    def init_app(self, app, **kwargs):
        ...
        os.environ.setdefault('SMS_ALIYUN_ACCESS_KEY_ID',app.config.get("SMS_ALIYUN_ACCESS_KEY_ID"))
        os.environ.setdefault('SMS_ALIYUN_ACCESS_KEY_SECRET', app.config.get("SMS_ALIYUN_ACCESS_KEY_SECRET"))
    ...
    def create_redis_instance(self):
        redis_instance = redis.Redis(
            host=self.app.config.get("SMS_REDIS_HOST"),
            port=self.app.config.get("SMS_REDIS_PORT"),
