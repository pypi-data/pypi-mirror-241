...
class Sample:
    ...
    def main(d: dict
        ...
        client = Sample.create_client(current_app.config.get('SMS_ALIYUN_ACCESS_KEY_ID'),
                                      current_app.config.get('SMS_ALIYUN_ACCESS_KEY_SECRET'))

        send_sms_request = dysmsapi_20170525_models.SendSmsRequest(
            sign_name=current_app.config.get('SMS_ALIYUN_SMS_SIGN_NAME'),
            template_code=current_app.config.get('SMS_ALIYUN_SMS_TEMPLATE_CODE'),
