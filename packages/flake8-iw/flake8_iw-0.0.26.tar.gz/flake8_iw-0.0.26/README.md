...
- [Supported lint checks](#supported-lint-checks)
  ...
  - [IW18: Direct assignment to constance, use override_config() instead](#iw18)
...
`parameterized.expand()` must be above `override_config`, `override_settings`, etc. Parameterized
