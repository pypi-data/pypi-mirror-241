...
class TrainModelMixin(object):
    ...
    def read_all_files_in_folder_mp(self,
        ...
        except BrokenProcessPool or AttributeError as e:
            MultiProcessingFailedWarning(msg=f'Multi-processing file read failed, reverting to single core (increased run-time).  Exception: {e.args}', source=self.__class__.__name__)
