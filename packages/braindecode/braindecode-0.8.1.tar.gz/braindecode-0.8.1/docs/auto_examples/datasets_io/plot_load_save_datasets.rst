...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <braindecode.datasets.moabb.MOABBDataset object at 0x7fe8652c0f10>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Writing /tmp/tmp6jixnyvl/0/0-raw.fif
    Closing /tmp/tmp6jixnyvl/0/0-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/1/1-raw.fif
    Closing /tmp/tmp6jixnyvl/1/1-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/2/2-raw.fif
    Closing /tmp/tmp6jixnyvl/2/2-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/3/3-raw.fif
    Closing /tmp/tmp6jixnyvl/3/3-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/4/4-raw.fif
    Closing /tmp/tmp6jixnyvl/4/4-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/5/5-raw.fif
    Closing /tmp/tmp6jixnyvl/5/5-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/6/6-raw.fif
    Closing /tmp/tmp6jixnyvl/6/6-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/7/7-raw.fif
    Closing /tmp/tmp6jixnyvl/7/7-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/8/8-raw.fif
    Closing /tmp/tmp6jixnyvl/8/8-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/9/9-raw.fif
    Closing /tmp/tmp6jixnyvl/9/9-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/10/10-raw.fif
    Closing /tmp/tmp6jixnyvl/10/10-raw.fif
    [done]
    Writing /tmp/tmp6jixnyvl/11/11-raw.fif
    Closing /tmp/tmp6jixnyvl/11/11-raw.fif
    [done]
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Opening raw data file /tmp/tmp6jixnyvl/1/1-raw.fif...
        Range : 0 ... 3868 =      0.000 ...   386.800 secs
    Ready.
    Reading 0 ... 3868  =      0.000 ...   386.800 secs...
    Opening raw data file /tmp/tmp6jixnyvl/3/3-raw.fif...
        Range : 0 ... 3868 =      0.000 ...   386.800 secs
    Ready.
    Reading 0 ... 3868  =      0.000 ...   386.800 secs...
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Using data from preloaded Raw for 1 events and 40 original time points ...
    Using data from preloaded Raw for 48 events and 40 original time points ...
    /home/bru/PycharmProjects/braindecode-new/braindecode/datasets/base.py:566: UserWarning: The number of saved datasets (2) does not match the number of existing subdirectories (12). You may now encounter a mix of differently preprocessed datasets!
      warnings.warn(f"The number of saved datasets ({i_ds+1+offset}) "
    /home/bru/PycharmProjects/braindecode-new/braindecode/datasets/base.py:574: UserWarning: Chosen directory /tmp/tmp6jixnyvl contains other subdirectories or files ['11', '2', '10', '3', '4', '6', '7', '5', '8', '9'].
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Reading /tmp/tmp6jixnyvl/0/0-epo.fif ...
