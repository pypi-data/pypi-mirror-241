...
.. _sphx_glr_auto_examples_datasets_io:
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="In this example, we compare the execution time and memory requirements of preprocessing data wi...">
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="In this example, we aim to show multiple ways of how you can split your datasets for training, ...">
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="Welcome to this tutorial where we demonstrate how to work with multiple discrete  targets for e...">
...
.. toctree::
   ...
   /auto_examples/datasets_io/benchmark_lazy_eager_loading
   /auto_examples/datasets_io/plot_benchmark_preprocessing
   /auto_examples/datasets_io/plot_custom_dataset_example
   /auto_examples/datasets_io/plot_load_save_datasets
   /auto_examples/datasets_io/plot_mne_dataset_example
   /auto_examples/datasets_io/plot_moabb_dataset_example
   /auto_examples/datasets_io/plot_split_dataset
   /auto_examples/datasets_io/plot_tuh_discrete_multitarget
