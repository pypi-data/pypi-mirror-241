...
setup(
    ...
    install_requires=[
        ...
        'rx>=3.0.0',
        'zaber_motion_bindings_windows==4.7.0;platform_system=="Windows"',
        'zaber_motion_bindings_linux==4.7.0;platform_system=="Linux"',
        'zaber_motion_bindings_darwin==4.7.0;platform_system=="Darwin"',
    ],
)
