                ...
                snapshot_builder_settings = data_repo_client.models.snapshot_builder_settings.SnapshotBuilderSettings(
                    ...
                    program_data_options = [
                        data_repo_client.models.snapshot_builder_program_data_option.SnapshotBuilderProgramDataOption(
                            ...
                            max = 56, 
                            values = [
                                data_repo_client.models.snapshot_builder_list_option.SnapshotBuilderListOption(
                                    id = 56, 
                                    name = '0', )
                                ], )
                        ], 
                    ...
                    dataset_concept_sets = [
                        data_repo_client.models.snapshot_builder_dataset_concept_sets.SnapshotBuilderDatasetConceptSets(
                            name = '0', 
