...
Массив -> Индекс минимального элемента
    ...
    def mn_i(massive):
        ...
        print_linear()
    elif answer.isnumeric() == True and answer != '1' and answer != '2' and answer != '3' and answer != '4' and answer != '5' and answer != '6':
        clear()
        print("Неправильное число. Допустимые числа: '1', '2', '3', '4', '5', '6'\n")
        print_linear()
    else:
        clear()
