...
from PyQt5.QtWidgets import (QAction, QApplication, QCheckBox, QDialog, QFileDialog, QLabel, QLineEdit, QMainWindow, QMessageBox, QProgressBar, QPushButton,
                             QRadioButton, QStackedWidget, QStatusBar, QSystemTrayIcon, QTreeWidget, QTreeWidgetItem)
