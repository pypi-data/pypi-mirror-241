...
import typing
import warnings
from typing import TYPE_CHECKING, Any, Dict, FrozenSet, List, Literal, Optional, Set, Tuple, Type, TypeVar, Union, cast
...
class ParsedAnnotation:
    ...
    def as_vector(self, annotation_override: type | None = None) -> Optional[Type[Vector]]:
        ...
        if annotation_override:
            ...
            self._parse_type(annotation_override)
