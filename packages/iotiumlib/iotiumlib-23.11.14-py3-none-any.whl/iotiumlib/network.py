...
def add(network_name, node_id=None, cluster_id=None, cidr=None, start_ip=None, gateway_ip=None, end_ip=None,
        ...
        enable_inter_tan=False, attached_to="LAN2"):
...
def edit(network_id, network_name=None, cidr=None, gateway_ip=None, start_ip=None, end_ip=None, label=None,
         ...
         static_routes=None, interface_ip=None, enable_inter_tan=None, attached_to=None):
    ...
    if attached_to is None:
        if 'attached_to' in resp.Response.output:
            attached_to = resp.Response.output['attached_to']['interfaces'][0]
