...
def create_chromium_document(fragment: str, dir: str = abspath(REPORTS_DIRECTORY)) -> str:
    ...
    with sync_playwright() as playwright:
        ...
        document.set_content(str(fragment), wait_until="load") # Wait until the page is fully loaded.
        document.wait_for_timeout(1000) # Wait for 1 second to be sure that the page is fully loaded.
