...
# 2023-11-14 13:42:42 TypeError: <lambda>() missing 9 required positional arguments: 'CLAUDE_API_KEY', 'LANGCHAIN_API_KEY', 'LANGCHAIN_ENDPOINT', 'LANGCHAIN_PROJECT', 'OPENAI_API_KEY', 'OPENAI_API_TYPE', 'SCORE_THRESHOLD_KB', 'SCORE_THRESHOLD', and 'STORE'
class ConfigDefaults(NamedTuple):
    ...
    SCORE_THRESHOLD_KB: Optional[str] = None
