"""
module decor.objective.

Package decor 's check class module
...
def Len_Dict(d: Dict):
    """
    function decor.objective.Len_Dict(d)
...
def STRING(args: List, kwargs: Dict):
    """
    function decor.objective.STRING(args, kwargs)
...
def INTEGER(args: List, kwargs: Dict):
    """
    function decor.objective.INTEGER(args, kwargs)
...
def LIST(args: List, kwargs: Dict):
    """
    function decor.objective.LIST(args, kwargs)
