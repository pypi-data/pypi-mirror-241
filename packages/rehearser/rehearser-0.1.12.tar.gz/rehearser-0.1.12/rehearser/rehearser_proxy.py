...
from rehearser.constants import FILTERED_ATTRS, GUMMIES_INTERACTIONS_FILE_TYPE, INTERACTIONS_KEY, INTERACTIONS_RAW_FILE_DEFAULT_DIRECTORY, InteractionType, SupportedInteractionsType
...
class RehearserProxy(RehearserMixin, object):
    ...
    def __init__(self, obj: Any) -> None:
        ...
        """
        self._rehearser_type = SupportedInteractionsType.PYTHON_INSTANCE.name
        self._obj = obj
        self._interactions = []
