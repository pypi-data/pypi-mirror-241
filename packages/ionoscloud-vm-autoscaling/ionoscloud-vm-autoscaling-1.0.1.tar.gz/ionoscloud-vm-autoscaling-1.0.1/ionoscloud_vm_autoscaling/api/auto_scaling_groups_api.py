...
class AutoScalingGroupsApi(object):
    ...
    def groups_actions_get(self, group_id, **kwargs):  # noqa: E501
        ...
        Retrieves the list of the last Auto Scaling actions or jobs performed by the VM Auto Scaling.The actions are specified by its ID. Only the last 10 actions are available  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_delete(self, group_id, **kwargs):  # noqa: E501
        """Delete a VM Auto Scaling Group by ID  # noqa: E501

        Deletes the VM Auto Scaling Group specified by its ID.  >Deleting the associated servers and disks is currently not implemented.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_find_by_id(self, group_id, **kwargs):  # noqa: E501
        ...
        Retrieves the VM Auto Scaling Group specified by its ID including the details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_get(self, **kwargs):  # noqa: E501
        """Get VM Auto Scaling Groups  # noqa: E501

        Lists all VM Auto Scaling Groups of your account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_post(self, group_post, **kwargs):  # noqa: E501
        """Create a VM Auto Scaling Group  # noqa: E501

        Creates a VM Auto Scaling Group.   > Note that creating a group triggers the creation of two monitoring alarms for 'Scale-In' and 'Scale-Out' operations according to the 'Policy' settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_put(self, group_id, group_put, **kwargs):  # noqa: E501
        """Update a VM Auto Scaling Group by ID  # noqa: E501

        Updates the VM Auto Scaling Group specified by its ID. The IDs assigned by the system when the resource is created, such as 'properties.datacenter.id' and 'backupunitId', are immutable and cannot be updated.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_servers_find_by_id(self, group_id, server_id, **kwargs):  # noqa: E501
        """Get VM Auto Scaling Group Server by ID  # noqa: E501

        Retrieves the properties of the server specified by its ID.  >Note that the server IDs of the VM Auto Scaling Groups are different from and do not match the VM server IDs in the data center.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def groups_servers_get(self, group_id, **kwargs):  # noqa: E501
        """Get VM Auto Scaling Group Servers  # noqa: E501

        Retrieves all servers associated with the VM Auto Scaling Group specified by its ID.   >Note that the server IDs of the VM Auto Scaling Groups are different from and do not match the VM server IDs in the data center.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
