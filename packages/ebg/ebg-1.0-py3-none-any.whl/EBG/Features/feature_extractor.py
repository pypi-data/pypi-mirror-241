...
class FeatureExtractor:
    ...
    def __init__(self, msa_file_path, tree_file_path, model_file_path, output_prefix, raxml_ng_path, redo):
        check_file_exists(msa_file_path, "fasta MSA file")
        check_file_exists(tree_file_path, "newick tree file")
        check_file_exists(model_file_path, "substitution model file")
