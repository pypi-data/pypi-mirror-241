...
def dolly(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
          ...
          *,
          ...
          use_mouse_init: typing.Optional[typing.Union[bool, typing.
                                                       Any]] = True):
    ...
    :type use_mouse_init: typing.Optional[typing.Union[bool, typing.Any]]
    '''
...
def edit_mesh_extrude_move_normal(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude and move along normals :file: `startup/bl_operators/view3d.py\:116 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/view3d.py$116>`_
...
def edit_mesh_extrude_move_shrink_fatten(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude and move along individual normals :file: `startup/bl_operators/view3d.py\:133 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/view3d.py$133>`_
...
def manipulator(
    ...
    :type constraint_orientation: typing.Optional[typing.Any]
    ...
    :type use_planar_constraint: typing.Optional[typing.Union[bool, typing.Any]]
    '''
...
def move(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
         ...
         undo: typing.Optional[bool] = None,
         *,
         use_mouse_init: typing.Optional[typing.Union[bool, typing.Any]] = True
         ):
    ''' Move the view
