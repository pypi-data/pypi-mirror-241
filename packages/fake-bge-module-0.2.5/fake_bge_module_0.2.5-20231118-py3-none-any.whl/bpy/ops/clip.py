...
def set_active_clip(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Undocumented :file: `startup/bl_operators/clip.py\:216 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$216>`_
...
def setup_tracking_scene(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Prepare scene for compositing 3D objects into this footage :file: `startup/bl_operators/clip.py\:982 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$982>`_
...
def tools(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
          execution_context: typing.Optional[typing.Union[str, int]] = None,
          undo: typing.Optional[bool] = None):
...
def track_settings_as_default(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to default settings :file: `startup/bl_operators/clip.py\:1019 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$1019>`_
...
def track_settings_to_track(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to selected tracks :file: `startup/bl_operators/clip.py\:1067 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/clip.py$1067>`_
