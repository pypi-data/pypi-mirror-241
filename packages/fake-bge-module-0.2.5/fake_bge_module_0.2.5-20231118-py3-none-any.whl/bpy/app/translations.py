...
def pgettext(msgid: typing.Optional[str], msgctxt: typing.Optional[str]):
...
def pgettext_data(msgid: typing.Optional[str], msgctxt: typing.Optional[str]):
...
def pgettext_iface(msgid: typing.Optional[str], msgctxt: typing.Optional[str]):
...
def pgettext_tip(msgid: typing.Optional[str], msgctxt: typing.Optional[str]):
