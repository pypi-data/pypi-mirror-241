...
class DeckLink:
    ...
    source: typing.Union['VideoDeckLink', 'ImageMirror', 'ImageViewport',
                         'ImageRender', 'ImageBuff', 'VideoFFmpeg',
                         'ImageFFmpeg', 'ImageMix'] = None
    ...
    :type: typing.Union['VideoDeckLink', 'ImageMirror', 'ImageViewport', 'ImageRender', 'ImageBuff', 'VideoFFmpeg', 'ImageFFmpeg', 'ImageMix']
    '''

    right: typing.Union['VideoDeckLink', 'ImageMirror', 'ImageViewport',
                        'ImageRender', 'ImageBuff', 'VideoFFmpeg',
                        'ImageFFmpeg', 'ImageMix'] = None
...
class ImageBuff:
    ...
    def load(self, imageBuffer: bytes, width: int, height: int):
        ''' Load image from buffer.

        :param imageBuffer: Buffer to load the image from.
        :type imageBuffer: bytes
...
class ImageMirror:
    ...
    colorBindCode: typing.Any = None
    ''' Off-screen color texture bind code.

    :type: typing.Any
    '''

    capsize: typing.List = None
    ''' Size of render area.
    ...
    def refresh(self, buffer: typing.Any = None, format: str = "RGBA"):
...
class ImageMix:
    ...
    def getSource(
            self, id: str
    ) -> typing.Union['ImageMirror', 'ImageViewport', 'ImageRender',
                      'ImageBuff', 'VideoFFmpeg', 'ImageFFmpeg', 'ImageMix']:
        ''' Get image source.

        :param id: Identifier of the source to get.
        :type id: str
        :rtype: typing.Union['ImageMirror', 'ImageViewport', 'ImageRender', 'ImageBuff', 'VideoFFmpeg', 'ImageFFmpeg', 'ImageMix']
        :return: Image source.
        '''
        pass
    ...
    def setSource(self, id: str, image: typing.Any):
        ''' Set image source - all sources must have the same size.

        :param id: Identifier of the source to set.
        :type id: str
        :param image:  Image source of type... * `VideoFFmpeg` * `ImageFFmpeg` * `ImageBuff` * `ImageMirror` * `ImageMix` * `ImageRender` * `ImageViewport`
...
def imageToArray(image: typing.Any, mode: str) -> typing.Any:
    ...
    :type mode: str
    :param image:  * `VideoFFmpeg` * `ImageFFmpeg` * `ImageBuff` * `ImageMirror` * `ImageMix` * `ImageRender` * `ImageViewport`
    :type image: typing.Any
    :rtype: typing.Any
...
def materialID(object: typing.Any, name: str) -> int:
