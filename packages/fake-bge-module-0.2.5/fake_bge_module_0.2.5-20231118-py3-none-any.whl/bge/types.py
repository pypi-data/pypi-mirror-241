...
class BL_Shader(EXP_PyObjectPlus):
    ...
    objectCallbacks: typing.List = None
    ...
    bindCallbacks: typing.List = None
    ...
    def setAttrib(self, enum: typing.Any):
        ''' Set attribute location. (The parameter is ignored a.t.m. and the value of "tangent" is always used.)

        :param enum: attribute location value
        :type enum: typing.Any
        '''
        pass
    ...
    def setSourceList(self, sources: typing.Dict, apply: bool):
...
class KX_2DFilterManager(EXP_PyObjectPlus):
    ...
    def addFilter(self, index: typing.Any, type: typing.Any,
                  fragmentProgram: str) -> 'KX_2DFilter':
    ...
    def getFilter(self, index: typing.Any) -> 'KX_2DFilter':
        ''' Return filter to the pass index :data:`index`. :warning: If the 2D Filter is added with a `SCA_2DFilterActuator`, the filter will be available only after the 2D Filter program is linked. The python script to get the filter has to be executed one frame later. A delay sensor can be used.
...
class KX_BlenderMaterial(EXP_PyObjectPlus):
    ...
    specularColor: typing.Union[typing.
                                Sequence[float], 'mathutils.Color'] = None
    ''' The material's specular color.

    :type: typing.Union[typing.Sequence[float], 'mathutils.Color']
    '''

    diffuseColor: typing.Union[typing.
                               Sequence[float], 'mathutils.Color'] = None
...
class KX_BoundingBox(EXP_PyObjectPlus):
    ...
    min: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ''' The minimal point in x, y and z axis of the bounding box.

    :type: typing.Union[typing.Sequence[float], 'mathutils.Vector']
    '''

    max: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ''' The maximal point in x, y and z axis of the bounding box.

    :type: typing.Union[typing.Sequence[float], 'mathutils.Vector']
    '''

    center: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
...
class KX_ConstraintWrapper(EXP_PyObjectPlus):
    ...
    def getParam(self, axis: typing.Any) -> float:
        ''' Get the contraint position or euler angle of a generic 6DOF constraint axis = 0..2 are linear constraint values * 0: X axis position * 1: Y axis position * 2: Z axis position
...
class KX_Scene(EXP_PyObjectPlus):
    ...
    texts: typing.Union['KX_FontObject', 'EXP_ListValue'] = None
    ''' A list of texts in the scene, (read-only).

    :type: typing.Union['KX_FontObject', 'EXP_ListValue']
    '''
    ...
    def addObject(self,
                  object: typing.Union['KX_GameObject', str],
                  reference: typing.Union['KX_GameObject', str],
                  time: float = 0.0) -> 'KX_GameObject':
        ''' Adds an object to the scene like the Add Object Actuator would.

        :param object: The (name of the) object to add.
        :type object: typing.Union['KX_GameObject', str]
        ...
        :type reference: typing.Union['KX_GameObject', str]
...
class KX_VehicleWrapper(EXP_PyObjectPlus):
    ...
    def addWheel(self, wheel: 'KX_GameObject', attachPos: typing.Any,
...
class KX_WorldInfo(EXP_PyObjectPlus):
    ...
    zenithColor: typing.Union[typing.
                              Sequence[float], 'mathutils.Vector'] = None
    ...
    ambientColor: typing.Union[typing.
                               Sequence[float], 'mathutils.Color'] = None
...
class KX_2DFilter(BL_Shader):
    ...
    def addOffScreen(self,
                     ...
                     width: typing.Any = -1,
                     height: typing.Any = -1,
                     hdr: typing.Any = 'bge.render.HDR_NONE',
                     mipmap: bool = False):
...
class BL_Texture(EXP_Value):
    ...
    renderer: typing.Union['KX_CubeMap', 'KX_PlanarMap'] = None
    ''' Texture renderer of this texture.

    :type: typing.Union['KX_CubeMap', 'KX_PlanarMap']
    '''
    ...
    uvOffset: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ''' Offset applied to texture UV coordinates (mainly translation on U and V axis).

    :type: typing.Union[typing.Sequence[float], 'mathutils.Vector']
    '''

    uvSize: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
...
class KX_BatchGroup(EXP_Value):
    ...
    def merge(self, objects: typing.Any):
        ...
        :type objects: typing.Any
        '''
        pass

    def split(self, objects: typing.Any):
...
class KX_Mesh(EXP_Value):
    ...
    def getVertex(self, matid: typing.Any,
                  index: typing.Any) -> 'KX_VertexProxy':
    ...
    def getPolygon(self, index: typing.Any) -> 'KX_PolyProxy':
    ...
    def replaceMaterial(self, matid: typing.Any,
    ...
    def constructBvh(
        ...
        :type transform: typing.Union[typing.Sequence[float], 'mathutils.Matrix']
...
class SCA_IController(SCA_ILogicBrick):
    ...
    useHighPriority: typing.Any = None
...
class KX_GameObject(SCA_IObject):
    ...
    components: 'EXP_ListValue' = None
    ''' All python components.

    :type: 'EXP_ListValue'
    '''

    children: 'EXP_ListValue' = None
    ''' direct children of this object, (read-only).

    :type: 'EXP_ListValue'
    '''

    childrenRecursive: 'EXP_ListValue' = None
    ...
    def applyMovement(self, movement: 'mathutils.Vector', local: typing.Any):
        ...
        :param local:  * False: get the "global" movement ie: relative to world orientation. * True: get the "local" movement ie: relative to object orientation. Default to False if not passed.
    ...
    def applyRotation(self, rotation: 'mathutils.Vector', local: typing.Any):
        ...
        :param local:  * False: get the "global" rotation ie: relative to world orientation. * True: get the "local" rotation ie: relative to object orientation. Default to False if not passed.
        :type local: typing.Any
        :param local:  boolean
        :type local: typing.Any
        '''
    ...
    def getReactionForce(self) -> typing.Any:
    ...
    def getVectTo(self, other: 'KX_GameObject') -> float:
    ...
    def rayCast(self,
                objto: 'KX_GameObject',
                objfrom: typing.Optional['KX_GameObject'] = None,
                dist: float = 0,
                prop: str = "",
                face: typing.Any = False,
                xray: typing.Any = False,
                poly: typing.Any = 0,
                mask: typing.Any = 0xFFFF) -> 'KX_PolyProxy':
        ...
        :type objfrom: typing.Optional['KX_GameObject']
    ...
    def reinstancePhysicsMesh(
            self,
            gameObject: typing.Optional[typing.Union[str, 'KX_GameObject']],
            meshObject: typing.Optional[str], dupli: bool) -> bool:
        ...
        :type gameObject: typing.Optional[typing.Union[str, 'KX_GameObject']]
...
class KX_ConstraintActuator(SCA_IActuator):
    ...
    direction: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
...
class KX_MouseActuator(SCA_IActuator):
    ...
    threshold: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ...
    sensitivity: typing.Union[typing.
                              Sequence[float], 'mathutils.Vector'] = None
    ...
    limit_x: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ...
    limit_y: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ...
    angle: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
...
class SCA_2DFilterActuator(SCA_IActuator):
    ...
    disableMotionBlur: typing.Any = None
...
class KX_RaySensor(SCA_ISensor):
    ...
    hitPosition: typing.Union[typing.
                              Sequence[float], 'mathutils.Vector'] = None
    ...
    hitNormal: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ...
    rayDirection: typing.Union[typing.
                               Sequence[float], 'mathutils.Vector'] = None
...
class KX_Camera(KX_GameObject):
    ...
    def getScreenPosition(
            self, object: typing.Union['KX_GameObject', 'mathutils.Vector']
    ) -> typing.List:
...
class KX_FontObject(KX_GameObject):
    ...
    dimensions: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
...
class KX_RadarSensor(KX_NearSensor):
    ...
    coneOrigin: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
    ''' The origin of the cone with which to test. The origin is in the middle of the cone. (read-only).

    :type: typing.Union[typing.Sequence[float], 'mathutils.Vector']
    '''

    coneTarget: typing.Union[typing.Sequence[float], 'mathutils.Vector'] = None
