...
def addon_refresh(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Scan add-on directories for new modules :file: `startup/bl_operators/wm.py\:1963 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1963>`_
...
def appconfig_default(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Undocumented :file: `startup/bl_operators/wm.py\:1394 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1394>`_
...
def blend_strings_utf8_validate(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Check and fix all strings in current .blend file to be valid UTF-8 Unicode (needed for some old, 2.4x area files) :file: `startup/bl_operators/file.py\:292 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/file.py$292>`_
...
def blenderplayer_start(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Launch the blender-player with the current blend-file :file: `startup/bl_operators/wm.py\:1500 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1500>`_
...
def collada_export(
        ...
        *,
        ...
        include_animations: typing.Optional[typing.Union[bool, typing.
                                                         Any]] = True,
        sample_animations: typing.Optional[typing.Union[bool, typing.
                                                        Any]] = False,
    ...
    :param sample_animations: Sample Animations, Auto-generate keyframes with a frame distance set by 'Sampling Rate'. When disabled, export only the keyframes defined in the animation f-curves (may be less accurate)
    :type sample_animations: typing.Optional[typing.Union[bool, typing.Any]]
...
def copy_prev_settings(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy settings from previous version :file: `startup/bl_operators/wm.py\:1466 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1466>`_
...
def keyconfig_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove key config :file: `startup/bl_operators/wm.py\:1785 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1785>`_
...
def keyconfig_test(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Test key-config for conflicts :file: `startup/bl_operators/wm.py\:1548 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1548>`_
...
def keyitem_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add key map item :file: `startup/bl_operators/wm.py\:1736 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1736>`_
...
def operator_cheat_sheet(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' List all the Operators in a text-block, useful for scripting :file: `startup/bl_operators/wm.py\:1797 <https://developer.blender.org/diffusion/B/browse/master/release/scripts /startup/bl_operators/wm.py$1797>`_
