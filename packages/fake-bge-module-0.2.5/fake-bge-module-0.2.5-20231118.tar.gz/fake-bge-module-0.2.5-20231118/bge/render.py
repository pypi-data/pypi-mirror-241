...
def getGLSLMaterialSetting(setting: str) -> bool:
...
def getMaterialMode(
        mode
) -> typing.Union['KX_TEXFACE_MATERIAL', 'KX_BLENDER_MULTITEX_MATERIAL',
                  'KX_BLENDER_GLSL_MATERIAL']:
    ''' Deprecated and no longer functional. Get the material mode to use for OpenGL rendering.

    :rtype: typing.Union['KX_TEXFACE_MATERIAL', 'KX_BLENDER_MULTITEX_MATERIAL', 'KX_BLENDER_GLSL_MATERIAL']
    '''
...
def getVsync() -> typing.Union['VSYNC_ON', 'VSYNC_ADAPTIVE']:
    ''' Get the current vsync value

    :rtype: typing.Union['VSYNC_ON', 'VSYNC_ADAPTIVE']
    '''
...
def setMaterialMode(
        mode: typing.
        Union['KX_TEXFACE_MATERIAL', 'KX_BLENDER_MULTITEX_MATERIAL',
              'KX_BLENDER_GLSL_MATERIAL']):
    ''' Deprecated and no longer functional. Set the material mode to use for OpenGL rendering.

    :param mode: material mode
    :type mode: typing.Union['KX_TEXFACE_MATERIAL', 'KX_BLENDER_MULTITEX_MATERIAL', 'KX_BLENDER_GLSL_MATERIAL']
    '''
