...
class LINE:
   ...
   def line_shakhes(candel_num , symbol_EURUSD , decimal_sambol , point5 , input_pos):
        ...
        if input_pos == "buy" and tp > ask and comp >= LINE().Min_Power_move and comp <= LINE().Max_power_move and amount_shakhes > (sprade * LINE().Max_spread) and sprade <= LINE().Manage_spread:
           ...
           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{input_pos})' + " _ " + "(comp:" + f'{comp})' + ' _ ' + "(Shakhes:" + f'{amount_shakhes})' + " _ " + "(sprade * Max_spread:"+ f'{sprade * LINE().Max_spread})'+ " _ " + "(sprade <= Manage_spread:" + f'{LINE().Manage_spread})' + " _ " + "(tp:" + f'{tp})'  + " _ " + "(ask:" + f'{ask})' + " _ " + "(bid:" + f'{bid})'+ " _ " + "(sprade:" + f'{sprade})'
           value = (candel_num , subject ,command)
