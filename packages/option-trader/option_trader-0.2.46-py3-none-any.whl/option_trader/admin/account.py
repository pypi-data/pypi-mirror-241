...
class account():
    ...
    def get_risk_matrix(self):
        ...
        position_summary
        symbol_risk = ops.groupby([position_summary.SYMBOL]).sum()[position_summary.MAX_RISK].to_dict()
        exp_date_risk = ops.groupby([position_summary.EXP_DATE]).sum()[position_summary.MAX_RISK].to_dict()
        strategy_risk = ops.groupby([position_summary.STRATEGY]).sum()[position_summary.MAX_RISK].to_dict()
