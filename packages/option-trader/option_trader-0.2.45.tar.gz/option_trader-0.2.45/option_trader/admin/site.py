    ...
    def send_site_user_account_report(self):
        ...
        for user_name in user_name_list:
            ...
            for account_name in account_name_list:
                ...
                print('{:10s}\t{:10s}\t{:10s}\t{:10s}'.format( 'user', 'account', 'open date', 'init balance') )         
                print('{:10s}\t{:15s}\t{:10s}\t{:.2f}\r\n'.format(u.user_name, a.account_name, str(open_date), initial_balance))    
                ...
                cc_str = '[%d|%.2f%%|$%.0f|$%.0f]' % (oc, oc_win_rate, oc_win_pl, oc_loss_pl)                                                    
                print('{:30s}\t{:30s}\t{:30s}'.format(tc_str, oc_str, cc_str) )        
                print('=========================================================================================')
