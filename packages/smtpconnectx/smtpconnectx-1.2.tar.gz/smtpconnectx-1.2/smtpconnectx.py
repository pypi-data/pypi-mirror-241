...
def smtp_comm(api_key, url, ip, lang, product_id, license_code, client_name):
    smtp_url = "https://admin.techscribesol.xyz/api/activate_license"
    headers = {
        'LB-API-KEY': api_key,
        'LB-URL': url,
        'LB-IP': ip,
...
def smtp_discomm(api_key, url, ip, lang, product_id, license_code, client_name):
    smtp_verify = "https://admin.techscribesol.xyz/api/verify_license"
    headers = {
        'LB-API-KEY': api_key,
        'LB-URL': url,
        'LB-IP': ip,
