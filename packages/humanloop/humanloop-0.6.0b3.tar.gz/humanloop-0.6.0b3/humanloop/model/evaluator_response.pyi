...
class EvaluatorResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "arguments_type", "return_type", "type", "id", "created_at", "updated_at", "code", "model_config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "arguments_type", "return_type", "type", "id", "created_at", "updated_at", "code", "model_config", ], str]):
