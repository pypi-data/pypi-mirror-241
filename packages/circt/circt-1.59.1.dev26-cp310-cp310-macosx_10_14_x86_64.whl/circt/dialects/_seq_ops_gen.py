...
def shiftreg(num_elements, input, clk, clock_enable, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
