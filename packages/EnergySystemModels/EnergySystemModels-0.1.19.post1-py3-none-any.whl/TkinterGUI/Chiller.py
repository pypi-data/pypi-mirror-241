...
# Same for saturated vapor
        ...
        self.Label_P1.config(text="EVAP.P_sat="+str(round(EVAP.Inlet.P/100000,2))+" bar")
      ...
      #  print(DESURCH.Inlet.P)
        ...
        self.Label_P4.config(text="DESURCH.P_sat="+str(round(DESURCH.Inlet.P/100000,2))+" bar") 
