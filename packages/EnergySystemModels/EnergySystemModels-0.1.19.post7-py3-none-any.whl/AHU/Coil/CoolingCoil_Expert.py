...
class Object:
    ...
    def calculate(self):
        #print("self.Inlet.P=",self.Inlet.P,"air_humide.P_sat(self.T_sat)=",air_humide.P_sat(self.T_sat),"self.T_sat=",self.T_sat)
        self.HA_sat=air_humide.HA(air_humide.P_sat(self.T_sat), 100, self.Inlet.P)
      ...
      #  Test du calcul de point de sortie à 90% d'humidité 7.5 g/kg, 12°C
        ...
        self.Inlet_HR=air_humide.HR(air_humide.P_sat(self.T_inlet),self.Inlet.HA,self.Inlet.P)
        ...
        if self.Inlet.HA>=self.HA_target and self.HA_target>=self.HA_sat: 
            ...
            if self.Inlet_HR<=90 :
                ...
                def syst(var): # définition du système
                    ...
                    eq2 =self.Outlet_Pvsat-air_humide.P_sat(self.T_Outlet) #calcul de T      
