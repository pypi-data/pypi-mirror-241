...
def glColor(red: typing.Any, green: typing.Any, blue: typing.Any,
            alpha: typing.Any):
...
def glPushAttrib(mask: typing.Any):
...
def glPushClientAttrib(mask: typing.Any):
...
def glVertex(x: typing.Any, y: typing.Any, z: typing.Any, w: typing.Any,
             v: 'Buffer'):
