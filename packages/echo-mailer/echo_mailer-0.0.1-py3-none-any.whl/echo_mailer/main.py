...
@email_monitor(to='604837926@qq.com', task_name="Test task for echo_mailer")
def test():
    sleep(1)
    raise Exception('CUDA error: no kernel image is available for execution on the device')
...
#
#     # Do something with arg1 and arg2, for example, concatenate them
#     result = f'Arguments received: arg1={arg1}, arg2={arg2}'
#     print(result)
#     return result


if __name__ == '__main__':
    # app.run(host='0.0.0.0', port=1428)
    test()
