...
class BaseModel(PydanticBaseModel, Generic[T]):
    ...
    def partial(cls, **kwargs):
        optional_model_name = f"Partial{cls.__name__}"
        optional_fields = {
            field: Optional[annotation] for field, annotation in
            cls.__annotations__.items()
        }
        partial_model = create_model(optional_model_name, **optional_fields)
