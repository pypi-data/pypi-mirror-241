...
class GenericCRUD:
    ...
    def insert(self, table_name: str = None, data_json: dict = None) -> int:
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error inserting data_json",
                                                     sql_statment=insert_query), object=e)
            logger.end()
            raise
    ...
    def update_by_where(self, table_name: str = None, where: str = None, params: tuple = None,
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error updating data_json",
                                                     sql_statment=update_query), object=e)
            logger.end()
            raise
    ...
    def delete_by_where(self, table_name: str = None, where: str = None, params: tuple = None) -> None:
        ...
        try:
            ...
            logger.exception(
                self._log_error_message(message="Error while deleting", sql_statment=update_query), object=e)
            logger.end()
            raise
    ...
    def select_multi_tuple_by_where(self, view_table_name: str, select_clause_value: str = "*",
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error selecting data_json",
                                                     sql_statment=select_query), object=e)
            logger.end()
            raise
