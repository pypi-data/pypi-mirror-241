...
class Interpellation:
    ...
    Attributes:
        ...
        repeated_interpellation (Union[Unset, List['Interpellation']]): a list of interpellations that were submitted
            after reciving unsatisfactory answer (request for additional explanations)
    """
    ...
    repeated_interpellation: Union[Unset, List["Interpellation"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        repeated_interpellation: Union[Unset, List[Dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for repeated_interpellation_item_data in _repeated_interpellation or []:
