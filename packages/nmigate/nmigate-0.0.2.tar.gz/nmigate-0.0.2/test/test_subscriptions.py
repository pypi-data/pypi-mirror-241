...
class TestSubs(unittest.TestCase):
    ...
    def test_custome_sale_using_vault(self):
        subscriptions = Subscriptions('4QaH5w77U2k843fu68EuB34c4M5KJ7r3', 'testOrg')
        result = subscriptions.custome_sale_using_vault(plan_id = "swzpremiumyear", customer_vault_id="1", create_customer_vault=False)
        self.assertEqual(result['nm_response']['response_code'][0], "100")


    def test_custome_sale_using_vault_month_frequency(self):
        subscriptions = Subscriptions('4QaH5w77U2k843fu68EuB34c4M5KJ7r3', 'testOrg')
        result = subscriptions.custome_sale_using_vault_month_frequency(request_sub = {
            "user_id": "1",
            "total_amount": "11",
