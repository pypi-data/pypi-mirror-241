...
class CustomRecast(BaseTextRecast):
    ...
    >>> text = 'You can have a look at our   catalogue  at \www.samplewebsite.com in the services tab'
    >>> rec = CustomRecast(characters={'  ': ' ', '   ': ' ', '\\': ''})
    >>> rec.setup(text)
    >>> rec.recast()
    'You can have a look at our catalogue at www.samplewebsite.com in the services tab'
    >>> # OR
    >>> rec.setup_recast(text)
    'You can have a look at our catalogue at www.samplewebsite.com in the services tab'
    >>> 
    ...
    def __init__(self, characters=None, verbose=0):
