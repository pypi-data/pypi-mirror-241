...
class MLP:
    ...
    def generate_document(self, raw_text: str, analyzers: List[str], json_object: dict = None, doc_paths=DEFAULT_DOC_PATH_KEY, lang=None, stanza_document=None, strip_html=True):
    ...
    def process(self, raw_text: str, analyzers: list = DEFAULT_ANALYZERS, lang=None, spans: str = "text", strip_html=True):
        ...
        document = self.generate_document(raw_text, loaded_analyzers, lang=lang, strip_html=strip_html)
    ...
    def process_docs(self, docs: List[dict], doc_paths: List[str], analyzers=DEFAULT_ANALYZERS, spans: str = "text", strip_html=True):
        """
        ...
        for doc_path in doc_paths:
            ...
            for lang, items in lang_group.items():
                pipeline = self.get_stanza_pipeline(lang, analyzers)
