...
class ImageRepositoryApi(object):
    ...
    @validate_arguments
    def create_image_repository(self, database : constr(strict=True), var_schema : constr(strict=True), image_repository : ImageRepository, create_mode : Optional[StrictStr] = None, **kwargs) -> CreateImageRepository200Response:  # noqa: E501
        ...
        :rtype: CreateImageRepository200Response
        """
    ...
    def create_image_repository_with_http_info(self, database : constr(strict=True), var_schema : constr(strict=True), image_repository : ImageRepository, create_mode : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateImageRepository200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "CreateImageRepository200Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_arguments
    def create_or_alter_image_repository(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), image_repository : ImageRepository, **kwargs) -> CreateImageRepository200Response:  # noqa: E501
        ...
        >>> thread = api.create_or_alter_image_repository(database, var_schema, name, image_repository, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_or_alter_image_repository_with_http_info(database, var_schema, name, image_repository, **kwargs)  # noqa: E501

    @validate_arguments
    def create_or_alter_image_repository_with_http_info(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), image_repository : ImageRepository, **kwargs):  # noqa: E501
        """Create a (or alter an existing) image repository.  # noqa: E501
        ...
        >>> thread = api.create_or_alter_image_repository_with_http_info(database, var_schema, name, image_repository, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_or_alter_image_repository" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/databases/{database}/schemas/{schema}/image-repositories/{name}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_image_repository(self, database : constr(strict=True), var_schema : constr(strict=True), name : constr(strict=True), if_exists : Optional[StrictBool] = None, **kwargs) -> CreateImageRepository200Response:  # noqa: E501
    ...
    @validate_arguments
    def list_image_repositories(self, database : constr(strict=True), var_schema : constr(strict=True), like : Optional[StrictStr] = None, starts_with : Optional[StrictStr] = None, show_limit : Optional[Dict[str, StrictStr]] = None, **kwargs) -> List[ImageRepository]:  # noqa: E501
        ...
        >>> thread = api.list_image_repositories(database, var_schema, like, starts_with, show_limit, async_req=True)
        >>> result = thread.get()
        ...
        :param show_limit:
        :type show_limit: ListImageRepositoriesShowLimitParameter
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_image_repositories_with_http_info(database, var_schema, like, starts_with, show_limit, **kwargs)  # noqa: E501

    @validate_arguments
    def list_image_repositories_with_http_info(self, database : constr(strict=True), var_schema : constr(strict=True), like : Optional[StrictStr] = None, starts_with : Optional[StrictStr] = None, show_limit : Optional[Dict[str, StrictStr]] = None, **kwargs):  # noqa: E501
        """List image repositories  # noqa: E501
        ...
        >>> thread = api.list_image_repositories_with_http_info(database, var_schema, like, starts_with, show_limit, async_req=True)
        >>> result = thread.get()
