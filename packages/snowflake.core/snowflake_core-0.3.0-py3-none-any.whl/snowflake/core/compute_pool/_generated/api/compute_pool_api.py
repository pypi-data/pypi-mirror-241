...
class ComputePoolApi(object):
    ...
    @validate_arguments
    def create_compute_pool(self, compute_pool : ComputePool, create_mode : Optional[StrictStr] = None, **kwargs) -> CreateComputePool200Response:  # noqa: E501
        ...
        :rtype: CreateComputePool200Response
        """
    ...
    def create_compute_pool_with_http_info(self, compute_pool : ComputePool, create_mode : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateComputePool200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "CreateComputePool200Response",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_arguments
    def create_or_alter_compute_pool(self, name : constr(strict=True), compute_pool : ComputePool, **kwargs) -> CreateComputePool200Response:  # noqa: E501
    ...
    @validate_arguments
    def delete_compute_pool(self, name : constr(strict=True), if_exists : Optional[StrictBool] = None, **kwargs) -> CreateComputePool200Response:  # noqa: E501
    ...
    @validate_arguments
    def fetch_compute_pools(self, like : Optional[StrictStr] = None, starts_with : Optional[StrictStr] = None, show_limit : Optional[Dict[str, StrictStr]] = None, **kwargs) -> List[ComputePool]:  # noqa: E501
        ...
        :param show_limit:
        :type show_limit: FetchComputePoolsShowLimitParameter
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    @validate_arguments
    def fetch_compute_pools_with_http_info(self, like : Optional[StrictStr] = None, starts_with : Optional[StrictStr] = None, show_limit : Optional[Dict[str, StrictStr]] = None, **kwargs):  # noqa: E501
        """List compute pools  # noqa: E501
    ...
    @validate_arguments
    def resume_compute_pool(self, name : constr(strict=True), **kwargs) -> CreateComputePool200Response:  # noqa: E501
    ...
    @validate_arguments
    def stop_all_services_in_compute_pool(self, name : constr(strict=True), **kwargs) -> CreateComputePool200Response:  # noqa: E501
    ...
    @validate_arguments
    def suspend_compute_pool(self, name : constr(strict=True), **kwargs) -> CreateComputePool200Response:  # noqa: E501
