...
class CreateComputePool200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateComputePool200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateComputePool200Response:
        """Create an instance of CreateComputePool200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateComputePool200Response.parse_obj(obj)

        _obj = CreateComputePool200Response.parse_obj({
