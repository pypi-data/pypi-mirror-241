...
from ..common import CreateMode, ObjectCollection, ObjectReferenceMixin
...
from ._generated.models.clone import Clone
from ._generated.models.model_schema import ModelSchema as Schema
...
class SchemaResource(ObjectReferenceMixin[SchemaCollection]):
    ...
    def fetch(self) -> Schema:
        return self.collection._api.fetch_schema(
            self.database.name,
            self.name,
            async_req=False,
        )
