...
class CloneTimeTravelPointOfTimeOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloneTimeTravelPointOfTimeOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloneTimeTravelPointOfTimeOneOf1:
        """Create an instance of CloneTimeTravelPointOfTimeOneOf1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CloneTimeTravelPointOfTimeOneOf1.parse_obj(obj)

        _obj = CloneTimeTravelPointOfTimeOneOf1.parse_obj({
