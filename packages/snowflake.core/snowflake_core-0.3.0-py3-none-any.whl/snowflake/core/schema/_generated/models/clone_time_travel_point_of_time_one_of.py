...
class CloneTimeTravelPointOfTimeOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloneTimeTravelPointOfTimeOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloneTimeTravelPointOfTimeOneOf:
        """Create an instance of CloneTimeTravelPointOfTimeOneOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CloneTimeTravelPointOfTimeOneOf.parse_obj(obj)

        _obj = CloneTimeTravelPointOfTimeOneOf.parse_obj({
