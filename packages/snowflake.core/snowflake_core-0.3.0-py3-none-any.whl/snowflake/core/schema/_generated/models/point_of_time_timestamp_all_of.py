...
class PointOfTimeTimestampAllOf(BaseModel):
    identifier: Optional[datetime] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointOfTimeTimestampAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointOfTimeTimestampAllOf:
        """Create an instance of PointOfTimeTimestampAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PointOfTimeTimestampAllOf.parse_obj(obj)

        _obj = PointOfTimeTimestampAllOf.parse_obj({
