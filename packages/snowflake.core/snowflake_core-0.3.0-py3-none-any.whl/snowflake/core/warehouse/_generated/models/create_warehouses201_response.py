...
class CreateWarehouses201Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWarehouses201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWarehouses201Response:
        """Create an instance of CreateWarehouses201Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateWarehouses201Response.parse_obj(obj)

        _obj = CreateWarehouses201Response.parse_obj({
