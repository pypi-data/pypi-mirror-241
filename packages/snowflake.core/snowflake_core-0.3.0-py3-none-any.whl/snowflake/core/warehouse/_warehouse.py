...
from snowflake.core.common import AccountObjectCollectionParent, CreateMode, ObjectReferenceMixin
...
class WarehouseCollection(AccountObjectCollectionParent["WarehouseResource"]):
    ...
    def create(
        ...
        *,
        ...
        self._api.create_warehouses(warehouse, StrictStr(real_mode), async_req=False)
...
class WarehouseResource(ObjectReferenceMixin[WarehouseCollection]):
    ...
    def create_or_update(
        ...
        """
        self.collection._api.create_warehouses(warehouse, async_req=False)
    ...
    def fetch(self) -> Warehouse:
        ...
        Example:
            ...
            >>> print(warehouse.name, warehouse.warehouse_size)
        """
        return self.collection._api.describe_warehouse(self.name, async_req=False)

    @api_telemetry
    def rename(self, new_warehouse: Warehouse) -> None:
        ...
        Args:
            new_warehouse: an instance of :class:`Warehouse`.
        ...
        """
        self.collection._api.rename_warehouse(self.name, new_warehouse, async_req=False)
        self.name = new_warehouse.name
