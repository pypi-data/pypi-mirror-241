...
from snowflake.core.table._generated.models.foreign_key import ForeignKey  # noqa: E501
...
class TestForeignKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ForeignKey`
        """
        model = snowflake.core.table._generated.models.foreign_key.ForeignKey()  # noqa: E501
        if include_optional :
            return ForeignKey(
