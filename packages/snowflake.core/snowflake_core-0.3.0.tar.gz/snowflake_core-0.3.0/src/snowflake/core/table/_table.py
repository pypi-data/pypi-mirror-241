...
from snowflake.core.common import CreateMode, SchemaObjectCollectionParent, SchemaObjectReferenceMixin
        ...
        *,
        ...
        return PagedIter(
            self._api.list_tables(
                ...
                starts_with=startswith, show_limit=limit, from_name=from_name, history=history, deep=deep,
                async_req=False
            ), Table._from_model
        )
