...
class ListImageRepositoriesShowLimitParameter(BaseModel):
    rows: StrictInt = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListImageRepositoriesShowLimitParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListImageRepositoriesShowLimitParameter:
        """Create an instance of ListImageRepositoriesShowLimitParameter from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListImageRepositoriesShowLimitParameter.parse_obj(obj)

        _obj = ListImageRepositoriesShowLimitParameter.parse_obj({
            "rows": obj.get("rows"),
