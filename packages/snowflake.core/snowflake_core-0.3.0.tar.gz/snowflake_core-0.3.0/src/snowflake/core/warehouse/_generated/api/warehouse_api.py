...
class WarehouseApi(object):
    ...
    def describe_warehouse(self, name : constr(strict=True), **kwargs) -> Warehouse:  # noqa: E501
        ...
        Describes the warehouse, show infomation of the choosen warehouse. Equivalent to DESCRIBE WAREHOUSE in SQL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_warehouses(self, like : Optional[StrictStr] = None, **kwargs) -> List[Warehouse]:  # noqa: E501
        ...
        Show a list of warehouse filted by pattern. Equivalent to SHOW WAREHOUSE in SQL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
