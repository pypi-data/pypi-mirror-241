...
class CloneTimeTravelPointOfTimeOneOf2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloneTimeTravelPointOfTimeOneOf2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloneTimeTravelPointOfTimeOneOf2:
        """Create an instance of CloneTimeTravelPointOfTimeOneOf2 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CloneTimeTravelPointOfTimeOneOf2.parse_obj(obj)

        _obj = CloneTimeTravelPointOfTimeOneOf2.parse_obj({
