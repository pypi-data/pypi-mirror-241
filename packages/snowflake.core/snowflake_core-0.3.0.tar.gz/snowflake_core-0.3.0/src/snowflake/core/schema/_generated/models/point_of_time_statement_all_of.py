...
class PointOfTimeStatementAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointOfTimeStatementAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointOfTimeStatementAllOf:
        """Create an instance of PointOfTimeStatementAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PointOfTimeStatementAllOf.parse_obj(obj)

        _obj = PointOfTimeStatementAllOf.parse_obj({
