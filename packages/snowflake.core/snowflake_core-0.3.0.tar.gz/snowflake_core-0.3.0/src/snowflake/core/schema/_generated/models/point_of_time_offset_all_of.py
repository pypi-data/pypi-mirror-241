...
class PointOfTimeOffsetAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointOfTimeOffsetAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointOfTimeOffsetAllOf:
        """Create an instance of PointOfTimeOffsetAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PointOfTimeOffsetAllOf.parse_obj(obj)

        _obj = PointOfTimeOffsetAllOf.parse_obj({
