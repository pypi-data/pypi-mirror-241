...
from snowflake.core._internal.utils import parse_table_name
from snowflake.core.common import CreateMode
...
def test_create_task_predecessors(tasks):
    try:
        task1 = tasks.create(
            Task(name=task_name1, definition="select current_version()"),
        )
