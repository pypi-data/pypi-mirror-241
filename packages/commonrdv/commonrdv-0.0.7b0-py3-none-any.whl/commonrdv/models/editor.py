...
from .token_ants_to_editor import TokenAntsToEditor
from .token_editor_to_ants import TokenEditorToAnts

from ..logging.app_logger import write_external_service_data
from ..utils.data_validator import capitalize_custom
...
from ..models.editor_model import Editor as EditorModel


def map(editor: EditorModel) -> Editor:
    editor.clean_token()
    return Editor(
        url=editor.url,
        name=editor.name,
