...
from ..to_t.embedding import get_embedding
...
class TextModule(torch.nn.Module):
    ...
    def prompt(self, prompt):
        self._prompt = prompt._prompt if isinstance(prompt, TextModule) else prompt if isinstance(prompt,                                                                       TextTensor) else TextTensor(
            prompt)
