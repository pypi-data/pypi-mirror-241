...
class OpenAIAssistantModule(TextModule):
    def __init__(self, assistant_id, model_name = "gpt-4-1106-preview", tools = None):
        super().__init__()
        auth(r"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")
    ...
    def forward(self, text_tensor: TextTensor):
        ...
        for user_message in text_tensor.to_list():
            ...
            if type == "message":
                ...
                responses.append(tool(**arguments))
