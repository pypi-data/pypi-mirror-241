...
logging.basicConfig(level=logging.DEBUG)  # Change to logging.INFO to suppress debug messages
...
class Text(str):
    ...
    def __new__(cls, *substrings, parse: Union[str, bool] = "auto", **named_substrings):
        """
