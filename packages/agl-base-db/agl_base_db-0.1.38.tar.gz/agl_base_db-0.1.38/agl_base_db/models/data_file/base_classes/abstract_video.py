...
class AbstractVideo(models.Model):
    ...
    endoscope_image_content_x = models.IntegerField(blank=True, null=True)
    endoscope_image_content_y = models.IntegerField(blank=True, null=True)
    endoscope_image_content_width = models.IntegerField(blank=True, null=True)
    endoscope_image_content_height = models.IntegerField(blank=True, null=True)
