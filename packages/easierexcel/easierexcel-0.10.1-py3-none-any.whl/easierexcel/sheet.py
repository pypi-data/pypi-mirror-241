...
class Sheet:
    def __init__(
        ...
        if not "full_date_format" in self.wb.named_styles:
            full_date_format_style = openpyxl.styles.NamedStyle(name="full_date_format")
            full_date_format_style.number_format = "dddd, mmmm d, yyyy"
    ...
    def get_style(self, row_value: str or int, column_value: str or int):
        """
        Gets the cell value based on the `row_value` and `column_value`.
    ...
    def get_format(self, row_value: str or int, column_value: str or int):
        """
        Gets the cell value based on the `row_value` and `column_value`.
