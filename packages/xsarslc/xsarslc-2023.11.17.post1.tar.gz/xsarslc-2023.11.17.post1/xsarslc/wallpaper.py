...
def plot_wallpaper(l1b_path, output_dir='.', png_name='wallpaper_xspectra.png'):
    """
    ...
    real_path = os.path.join(output_dir, filename+'_real'+ext)
    imag_path = os.path.join(output_dir, filename+'_imag'+ext)
...
def make_wallpaper(l1b_path):
    ...
    Return:
        xarray.Dataset : datset of intraburst cross-spectra plots
    """
    import datatree
...
def xs_figures(xs, heading = 0, incidence = None, tau = None, cutoff = None, lon=None, lat=None, **kwargs):
    """
