...
class UpdateInterface(ABC):
    ...
    def api_key(self, api_key_id: UUID, data: dict) -> models.APIKeyDataResponse:
    ...
    def role(self, role_id: UUID, data: dict) -> models.RoleDataResponse:
        return self._role(
            role_id=role_id,
            data=self._process_data(data),
        )
    ...
    def user(self, user_id: UUID, data: dict) -> models.UserDataResponse:
