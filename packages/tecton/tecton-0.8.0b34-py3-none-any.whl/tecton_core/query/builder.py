...
def wip_build_compaction_query(
    ...
    if fdw.is_temporal_aggregate:
        ...
        node = TakeLastRowNode.for_feature_definition(dialect=dialect, fdw=fdw, input_node=fv_pipeline)
        node = TemporalBatchTableFormatNode.for_feature_definition(dialect=dialect, fdw=fdw, input_node=node)
