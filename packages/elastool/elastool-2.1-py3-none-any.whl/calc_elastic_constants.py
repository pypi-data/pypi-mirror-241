...
def Cubic(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor):
    ...
    return elastic_constants_dict,elastic_tensor_3d
...
def isotropy(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor):
    ...
    return elastic_constants_dict,elastic_tensor_2d
...
def Nanotube(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor):
    ...
    return elastic_constants_dict,elastic_tensor_1d
...
def calc_elastic_constants(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict):
    ...
    if strains_matrix != 'asess':
        if latt_system == 'Cubic':
            elastic_constants_dict,elastic_tensor = Cubic(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Hexagonal':
            elastic_constants_dict,elastic_tensor = Hexagonal(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)
                
        elif latt_system == 'Trigonal1':
            elastic_constants_dict, elastic_tensor = Trigonal1(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Trigonal2':
            elastic_constants_dict,elastic_tensor = Trigonal2(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Tetragonal1':
            elastic_constants_dict,elastic_tensor = Tetragonal1(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Tetragonal2':
            elastic_constants_dict,elastic_tensor = Tetragonal2(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Orthorombic':
            elastic_constants_dict,elastic_tensor = Orthorombic(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'Monoclinic':
            elastic_constants_dict ,elastic_tensor = Monoclinic(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)
                
        elif latt_system == 'Triclinic':
            elastic_constants_dict,elastic_tensor = Triclinic(latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)
        
        elif latt_system == 'isotropy':
            elastic_constants_dict,elastic_tensor = isotropy(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'tetragonal':
            elastic_constants_dict,elastic_tensor = tetragonal(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'orthotropy':
            elastic_constants_dict,elastic_tensor = orthotropy(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)

        elif latt_system == 'anisotropy':
            elastic_constants_dict, elastic_tensor = anisotropy(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)                        

        elif latt_system == 'Nanotube':
            elastic_constants_dict,elastic_tensor = Nanotube(pos_optimized, latt_system, elastic_constants_dict, stress_set_dict, conversion_factor)   
    ...
    return elastic_constants_dict,elastic_tensor
