...
# When `parse_response == True`, return string representing input text with PII entities redacted.
# Else, return raw API json output.
@tool 
def get_pii_entity_recognition(connection:CustomConnection, language:str, text:str, domain:str="none", categories:list=[], parse_response:bool=False): 
    # Create inputs:
