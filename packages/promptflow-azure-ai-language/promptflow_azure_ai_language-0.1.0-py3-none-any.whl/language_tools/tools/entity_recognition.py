...
SKILL = Skill.ENTITY_RECOGNITION 
MODE = Mode.SYNC

# When `parse_response == True`, return dictionary of recognized entities: key=<entity text>, value=<entity category>.
# Else, return raw API json output.
@tool 
def get_entity_recognition(connection:CustomConnection, language:str, text:str, parse_response:bool=False): 
    # Create inputs:
