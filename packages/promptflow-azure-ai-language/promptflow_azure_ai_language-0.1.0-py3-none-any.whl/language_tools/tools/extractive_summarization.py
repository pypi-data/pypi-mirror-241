...
SKILL = Skill.EXTRACTIVE_SUMMARIZATION
MODE = Mode.ASYNC

# When `parse_response == True`, return list of strings representing extracted summary sentences.
# Else, return raw API json output.
@tool 
def get_extractive_summarization(connection:CustomConnection, language:str, text:str, query:str="", sentence_count:int=3, sort_by:str="Offset", parse_response:bool=False):
    # Create inputs:
