...
def plot_bar_mat(a, b, qmin, qmax, qscore, work_dir, plot_name):
    ...
    ax.annotate(f'{qscore:.3f}', (1.57, 0.2), color='black', ha='center', fontsize=12)
    # ax.annotate(f'{qscore:.3f}', (1.56, 0.2), color='black', ha='center', fontsize=12)

    ax.annotate('Q-score', (-0.1, 0.2), color='black', ha='center', fontsize=12)
    ax.annotate('Metric', (-0.1, 1.7), color='black', ha='center', fontsize=14)
    ax.annotate('Percentile Ranks', (0.75, 1.7), color='black', ha='center', fontsize=14)
    # ax.annotate('EMD-28816',(0.75, 3.3), color='black', ha='center', fontsize=14, fontweight='bold')
    ax.annotate('Value', (1.56, 1.7), color='black', ha='center', fontsize=14)
    # if a >= b:
...
def bar(new_entry_dict, score_type, work_dir, plot_name):
    input_file = 'qscores.csv'
