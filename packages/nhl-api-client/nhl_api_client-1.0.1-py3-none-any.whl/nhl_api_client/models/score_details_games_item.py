...
class ScoreDetailsGamesItem:
    ...
    Attributes:
        ...
        game_date (Union[Unset, str]):
        venue (Union[Unset, LanguageString]):
        start_time_utc (Union[Unset, str]):
        ...
        clock (Union[Unset, ScoreDetailsGamesItemClock]):
    ...
    clock: Union[Unset, "ScoreDetailsGamesItemClock"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        game_date = d.pop("gameDate", UNSET)
        ...
        start_time_utc = d.pop("startTimeUTC", UNSET)
