...
from inhandtest.pages.er_device.config.config import EAP600Config
from inhandtest.pages.er_device.security.security import ER805Security
...
class ER805(BasePage):
    ...
    def __init__(self, host: str, super_user: str, super_password: str, page: Page = None, model='ER805',
        ...
        self.security = ER805Security(host, username, password, protocol, port, model, language, self.page,
                                   locale=self.locale)
...
if __name__ == '__main__':
    ...
    with ER805Security('10.5.23.160', ) as device:
