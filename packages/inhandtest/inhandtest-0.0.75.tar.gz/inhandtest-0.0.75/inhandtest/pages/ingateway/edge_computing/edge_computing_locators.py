...
class DeviceSupervisorLocators:
    ...
    @property
    def protocol_modbus_tcp_locator(self) -> list:
        return [
            ('enable', {'locator': self.page.locator('#enable'), 'type': 'switch_button'}),
    ...
    @property
    def protocol_modbus_tcp_operation(self) -> list:
        return [
            ('controller',
    ...
    def protocol_modbus_mapping_table(self, name) -> list:
    ...
    @property
    def protocol_modbus_mapping_table_add(self) -> list:
        return [
            ('controller', {'locator': self.pop_up.locator('#ctrlName'), 'type': 'select'}),
            ('measure',
    ...
    @property
    def protocol_modbus_mapping_table_batch_add(self) -> list:
        return [
            ('start_mapping_address_type',
             {'locator': self.pop_up.locator('.ant-select.ant-select-enabled').first, 'type': 'select'}),
    ...
    def protocol_modbus_mapping_batch_table(self, name) -> list:
        measure_name = f'//div[@class="ant-table-body"]//td[text()="{name}"]'
        return [
