...
# 1 "<command-line>" 2
# 1 "/__w/flux-python/flux-python/src/_security_clean.h"
# 35 "/__w/flux-python/flux-python/src/_security_clean.h"
enum {
...
# 95 "/__w/flux-python/flux-python/src/_security_clean.h"
enum {
    FLUX_SIGN_NOVERIFY = 1,
};
# 106 "/__w/flux-python/flux-python/src/_security_clean.h"
...
const char *flux_sign_wrap_as (flux_security_t *ctx,
                               ...
                               const char *mech_type,
                               int flags);
# 132 "/__w/flux-python/flux-python/src/_security_clean.h"
