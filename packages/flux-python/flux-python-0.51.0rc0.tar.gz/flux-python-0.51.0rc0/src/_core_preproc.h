...
# 900 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 985 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1024 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1101 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1152 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1173 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1275 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg, const char **topic,
                          const char **s);
# 1286 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1499 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1577 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1619 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1688 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_panic (flux_t *h, uint32_t nodeid, int flags, const char *reason);
# 1717 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1828 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1901 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1949 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1987 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 2071 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 2114 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2126 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2178 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2216 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2303 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2372 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2415 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2447 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2599 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2614 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2687 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2737 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2746 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2778 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2856 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2912 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2952 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2973 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3021 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3091 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3102 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3233 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3247 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3383 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3445 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3529 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3538 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3733 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3764 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3779 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3799 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3845 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3906 "/__w/flux-python/flux-python/src/_core_clean.h"
