...
impl NifpgaFastFifoRecv {
    ...
    #[new]
    #[pyo3(signature = (bitfile = "X", signature = "ABCD12345678", ni_address = "RI0", run = false, close_on_reset = false, fifo = 0, dma_buffer_size=50000, fifo_reading_buffer=10000, min_packet=1, debug = false))]
    fn new(bitfile: &str,
           signature: &str,
           ni_address:  &str,
           run: bool,
