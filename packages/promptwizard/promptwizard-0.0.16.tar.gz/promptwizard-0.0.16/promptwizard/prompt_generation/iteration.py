...
def iterate(test_cases, method, prompts, iteration, best_percentage=100, best_prompts=2, functions: Dict=None, model_test: str='gpt-3.5-turbo', model_test_temperature: float=1.2, model_test_max_tokens: int=1000, model_iteration: str='gpt-4-turbo', model_iteration_temperature: float=0.6, model_iteration_max_tokens: int=500, function_call: str='auto', description: str=None, model_embeddings: str='text-embedding-ada-002', timeout: int=10, n_retries: int=5):
    ...
    if method != 'Elo' and method != 'Semantic Similarity':
        ...
        while (iteration > 0 and (not all_have_rating_percentage)):
            print(f"Iteration number {number_of_iteration}")
            combine_prompts = []
            if method == 'Function Calling':
                new_results_prompts_cost = iterations(test_cases, method, old_prompts, number_of_prompts - best_prompts, functions, model_test, model_test_temperature, model_test_max_tokens, model_iteration, model_iteration_temperature, model_iteration_max_tokens, function_call, None, best_prompts, timeout, n_retries)
                final_results.append(new_results_prompts_cost)

            if method != 'Function Calling':
                new_results_prompts_cost = iterations(test_cases, method, old_prompts, number_of_prompts - best_prompts, None, model_test, model_test_temperature, model_test_max_tokens, model_iteration, model_iteration_temperature, model_iteration_max_tokens, None, None, best_prompts, timeout, n_retries)
                final_results.append(new_results_prompts_cost)
    ...
    if method == 'Semantic Similarity':
        ...
        while (iteration > 0):
            ...
            new_results_prompts_cost = iterations(test_cases, method, old_prompts, number_of_prompts - best_prompts, None, model_test, model_test_temperature, model_test_max_tokens, model_iteration, model_iteration_temperature, model_iteration_max_tokens, None, None, best_prompts, model_embeddings, timeout, n_retries)
            final_results.append(new_results_prompts_cost)
            new_results = new_results_prompts_cost[0]
            cost = cost + new_results_prompts_cost[1]
            tokens_input_gen_iter = tokens_input_gen_iter + new_results_prompts_cost[2]
    ...
    if method == 'Elo':
        ...
        while iteration > 0:
            ...
            combine_prompts = []
            new_results_prompts_cost = iterations(test_cases, method, prompt_contents, number_of_prompts - best_prompts, None, model_test, model_test_temperature, model_test_max_tokens, model_iteration, model_iteration_temperature, model_iteration_max_tokens, None, description, best_prompts, timeout, n_retries)
            final_results.append(new_results_prompts_cost)
            new_results = new_results_prompts_cost[0]
            cost = cost + new_results_prompts_cost[1]
            tokens_input_gen_iter = tokens_input_gen_iter + new_results_prompts_cost[2]
