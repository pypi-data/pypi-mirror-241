...
class Ui_DialogScenarioProperties(object):
    def setupUi(self, DialogScenarioProperties):
        ...
        self.lineEditStartTime1 = QLabel(self.groupBoxStartTime)
        self.lineEditStartTime1.setObjectName(u"lineEditStartTime1")
        self.lineEditStartTime1.setMinimumSize(QSize(0, 0))

        self.horizontalLayoutFameStartTime.addWidget(self.lineEditStartTime1)
        ...
        self.horizontalLayoutStopTime.addWidget(self.fame_stop_time)
    ...
    def retranslateUi(self, DialogScenarioProperties):
        ...
        self.lineEditStartTime1.setText(
            QCoreApplication.translate("DialogScenarioProperties", u"FAME Start time:", None))
