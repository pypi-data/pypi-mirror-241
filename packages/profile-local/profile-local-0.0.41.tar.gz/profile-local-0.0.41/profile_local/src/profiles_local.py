...
class ProfilesLocal(GenericCRUD):
    ...
    def __init__(self):
        super().__init__(schema_name="profile", default_table_name="profile_table", view_table_name="profile_view",
                         default_id_column_name="profile_id")
        logger.start()
        logger.end()
    ...
    def insert(self, person_id: int, profile_dict: Dict[str, any]) -> int:
        ...
        profile_ml_table_json = {
            ...
            "`name`": profile_dict.get('profile_name'),
