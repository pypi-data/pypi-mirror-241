...
configuration:
  # if you want to use a custom runtime, add the runtime id and name below, can find it by running `inferless runtime list`  NOTE: this is not supported for Serverless
  custom_runtime_id: ''
  custom_runtime_name: ''
  # if you want to use a custom volume, add the volume id and name below, can find it by running `inferless volume list` NOTE: this is not supported for Serverless
  custom_volume_id: ''
  custom_volume_name: ''
