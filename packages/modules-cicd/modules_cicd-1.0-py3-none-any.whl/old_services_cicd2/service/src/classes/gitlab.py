...
aws_access_key_id = 'AKIARK6TQEWT37ZG5POQ'
aws_secret_access_key = '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'
s3_client = boto3.client('s3', aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key, region_name='us-east-2')
lambda_client = boto3.client('lambda', aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key, region_name='us-east-2')
...
class GitLabAPI(RepoAPI):
    ...
    def search_group(self, group_name: str):
        try:
            ...
            raise Exception(f"Error searching for group: {err}")
    ...
    def clone_and_push_repo(
        ...
        try:
            ...
            raise Exception(f"File upload error: {err}")
