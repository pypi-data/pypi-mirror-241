...
def openai_function(
    ...
    An OpenAI Function is a special subclass of Pydantic BaseModel:
        - Attributes are defined by your function's parameters.
        - `schema` class attribute describes the function as a JSON Schema.
        - `__call__` method (no arguments) that passes instance attributes to the original function.
        - `from_json` class method creates the model from a JSON string.
        - `function` property returns the original decorated function.
    ...
    There are two ways the openai function differs from traditional Pydantic model behavior.
        ...
        - If your function allows positional arguments, then your model will allow positional arguments.
