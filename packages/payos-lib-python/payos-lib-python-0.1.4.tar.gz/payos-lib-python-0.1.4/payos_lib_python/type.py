...
class PaymentData:
    def __init__(self, orderCode: int, amount: int, description: str, items: list[ItemData], cancelUrl: str, returnUrl: str, buyerName: str = None,\
    ...
    def get_items_to_str(self):
        return str([x.to_json() for x in self.items ])
