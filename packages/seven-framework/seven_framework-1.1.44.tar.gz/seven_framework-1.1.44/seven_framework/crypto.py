...
:LastEditTime: 2023-11-16 20:20:15
...
class CryptoHelper:
    ...
    @classmethod
    def get_dir_hash(cls, dir_path,hashfunc="md5",excluded_files=None,ignore_hidden=True,followlinks=False,excluded_extensions=None,include_paths=False):
        """
        :description: 计算目录哈希值
        :param path
        :return 目录哈希值
