    ...
    def test_newwrite(self):
        ...
        if not (
            ...
            if not (textpart_object.italicchars_ratio == retrieved_object.italicchars_ratio):
                Answer = False
            if not (textpart_object.italicratio_threshold == retrieved_object.italicratio_threshold):
                Answer = False
    ...
    def test_newwrite(self):
        ...
        if not (
            ...
            if not (len(retrieved_object.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
            if not (len(retrieved_object.title.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
            if not (len(retrieved_object.footer.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
            if not (len(retrieved_object.headlines.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
            if not (len(retrieved_object.enumeration.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
            if not (len(retrieved_object.body.copied_native_TOC)==len(textpart_object.native_TOC)):
                Answer = False
