    ...
    def test_overwrite(self):
        ...
        if not (
            ...
            if not (textpart_object_2.italicchars_ratio == retrieved_object.italicchars_ratio):
                Answer = False
            if not (textpart_object_2.italicratio_threshold == retrieved_object.italicratio_threshold):
                Answer = False
            ...
            if not (textpart_object_2.is_fiche == retrieved_object.is_fiche):
                Answer = False
            if not (textpart_object_2.textextractionmethod == retrieved_object.textextractionmethod):
                Answer = False
    ...
    def test_overwrite(self):
        ...
        if not (
            ...
            if not (len(retrieved_object.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
            if not (len(retrieved_object.title.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
            if not (len(retrieved_object.footer.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
            if not (len(retrieved_object.headlines.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
            if not (len(retrieved_object.enumeration.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
            if not (len(retrieved_object.body.copied_native_TOC)==len(textpart_object_2.native_TOC)):
                Answer = False
