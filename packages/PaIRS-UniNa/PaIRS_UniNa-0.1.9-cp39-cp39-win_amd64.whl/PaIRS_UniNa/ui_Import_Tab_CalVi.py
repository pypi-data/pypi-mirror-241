...
"")
        ...
        icon7 = QIcon()
        icon7.addFile(u"../PAIRS_GUI/"+ icons_path +"down.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u"../PAIRS_GUI/"+ icons_path +"up.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border-bottom: 1px solid gray;\n"
"padding: 2px;")
        self.label_check_path_out.setPixmap(QPixmap(u"../PAIRS_GUI/"+ icons_path +"greenv.png"))
        ...
        icon12 = QIcon()
        icon12.addFile(u"../PAIRS_GUI/"+ icons_path +"browse_folder_c.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border-bottom: 1px solid gray;\n"
"padding: 2px;")
        self.label_check_root.setPixmap(QPixmap(u"../PAIRS_GUI/"+ icons_path +"greenv.png"))
