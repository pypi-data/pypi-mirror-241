...
from notevault.create_schemas import Content, DocumentSchema, generate_models_from_yaml
...
class Main:
    ...
    def edit_and_parse(
        ...
        parsed_obj = parse_markdown(
            updated_content, self.document_spec, self.generated_schemas
        )
