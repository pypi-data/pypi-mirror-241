...
const ENTRY_CSS = "./assets/index-aa8d4ca5.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-70082047.js').then(n => n.I),true?["./Index-70082047.js","./Index-8284f94b.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-3dee6bd4.js.map
