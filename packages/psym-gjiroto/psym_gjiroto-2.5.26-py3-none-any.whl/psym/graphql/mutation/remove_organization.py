...
class removeOrganization:
    ...
    class removeOrganizationData(DataClassJsonMixin):
        removeOrganization: str
    ...
    def execute(cls, client: Client, id: str) -> str:
        ...
        res = cls.removeOrganizationData.from_dict(response_text)
        return res.removeOrganization
