...
from ..enum.recommendations_order_field import RecommendationsOrderField


@dataclass(frozen=True)
class RecommendationsOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[RecommendationsOrderField] = None
