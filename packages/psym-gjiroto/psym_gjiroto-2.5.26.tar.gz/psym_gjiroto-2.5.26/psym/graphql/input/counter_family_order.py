...
from ..enum.counter_family_order_field import CounterFamilyOrderField
from ..enum.order_direction import OrderDirection


@dataclass(frozen=True)
class CounterFamilyOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[CounterFamilyOrderField] = None
