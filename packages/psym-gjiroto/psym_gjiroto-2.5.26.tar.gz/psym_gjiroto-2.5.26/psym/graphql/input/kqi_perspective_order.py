...
from ..enum.kqi_perspective_order_field import KqiPerspectiveOrderField
from ..enum.order_direction import OrderDirection


@dataclass(frozen=True)
class KqiPerspectiveOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[KqiPerspectiveOrderField] = None
