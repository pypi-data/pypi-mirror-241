...
from ..enum.event_severity_order_field import EventSeverityOrderField
from ..enum.order_direction import OrderDirection


@dataclass(frozen=True)
class EventSeverityOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[EventSeverityOrderField] = None
