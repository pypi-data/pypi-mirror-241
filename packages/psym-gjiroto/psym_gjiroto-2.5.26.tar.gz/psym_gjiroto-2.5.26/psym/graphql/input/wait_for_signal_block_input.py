...
from ..enum.signal_module import SignalModule
from ..enum.signal_type import SignalType
...
class WaitForSignalBlockInput(DataClassJsonMixin):
    basicDefinitions: BaseBlockInput
    blocked: bool
    cid: str
    params: List[VariableExpressionInput]
    signalModule: SignalModule = _field(metadata=enum_field_metadata(SignalModule))
    type: SignalType = _field(metadata=enum_field_metadata(SignalType))
