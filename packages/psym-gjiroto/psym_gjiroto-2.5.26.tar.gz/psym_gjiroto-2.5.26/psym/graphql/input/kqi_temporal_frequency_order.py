...
from ..enum.kqi_temporal_frequency_order_field import KqiTemporalFrequencyOrderField
from ..enum.order_direction import OrderDirection


@dataclass(frozen=True)
class KqiTemporalFrequencyOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[KqiTemporalFrequencyOrderField] = None
