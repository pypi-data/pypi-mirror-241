...
def validate_aoai_deployments(
    ...
    if llm_config and llm_connection:
        ...
        if hasattr(credential, "key"):
            ...
            completion_params["openai_api_base"] = llm_connection.target
            connection_metadata = llm_connection.metadata
            ...
            completion_params["connection"] = llm_connection.id
    ...
    if embeddings_model and embeddings_connection:
        ...
        if hasattr(credential, "key"):
            ...
            embedding_params["openai_api_base"] = embeddings_connection.target
            connection_metadata = embeddings_connection.metadata
            ...
            embedding_params["connection"] = embeddings_connection.id
        ...
        activity_logger.info(
            ...
            extra={
                "properties": {
                    "connection": embeddings_connection.id,
...
def validate_acs(
    ...
    for index in range(MAX_RETRIES + 1):
        try:
            ...
            acs_config["endpoint"] = acs_connection.target
            acs_metadata = acs_connection.metadata
            acs_config["api_version"] = acs_metadata.get("apiVersion", "2023-07-01-preview")
            connection_args = {}
            connection_args["connection_type"] = "workspace_connection"
            connection_args["connection"] = {"id": acs_connection.id}
