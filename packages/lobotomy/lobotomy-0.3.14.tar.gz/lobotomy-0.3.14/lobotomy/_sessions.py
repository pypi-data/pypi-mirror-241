...
class Session:
    ...
    def __init__(
        ...
        botocore_session: typing.Optional[BotocoreSession] = None,
        profile_name: typing.Optional[str] = None,
        source_lobotomy: typing.Optional["Lobotomy"] = None,
    ):
...
class Lobotomy:
    ...
    def __init__(
        ...
        client_overrides: typing.Optional[typing.Dict[str, typing.Any]] = None,
    ):
