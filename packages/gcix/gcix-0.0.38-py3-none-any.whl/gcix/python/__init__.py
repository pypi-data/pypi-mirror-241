...
from ..pages import (
    PagesSphinx as _PagesSphinx_25bcdef0,
    PagesSphinxProps as _PagesSphinxProps_0f6d5fcd,
)
...
class IPythonFullStack(typing_extensions.Protocol):
    ...
    def sphinx_job(self) -> typing.Optional[_PagesSphinx_25bcdef0]:
        ...

    @sphinx_job.setter
    def sphinx_job(self, value: typing.Optional[_PagesSphinx_25bcdef0]) -> None:
        ...
...
class _IPythonFullStackProxy:
    ...
    @jsii.member(jsii_name="sphinxJob")
    def sphinx_job(self) -> typing.Optional[_PagesSphinx_25bcdef0]:
        return typing.cast(typing.Optional[_PagesSphinx_25bcdef0], jsii.get(self, "sphinxJob"))
...
class PythonFullStack(
    ...
    def __init__(
        ...
        *,
        ...
        sphinx_props_job_props: typing.Optional[typing.Union[_PagesSphinxProps_0f6d5fcd, typing.Dict[builtins.str, typing.Any]]] = None,
...
class PythonFullStackProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(sphinx_props_job_props, dict):
            sphinx_props_job_props = _PagesSphinxProps_0f6d5fcd(**sphinx_props_job_props)
    ...
    @builtins.property
    def sphinx_props_job_props(self) -> typing.Optional[_PagesSphinxProps_0f6d5fcd]:
        result = self._values.get("sphinx_props_job_props")
        return typing.cast(typing.Optional[_PagesSphinxProps_0f6d5fcd], result)
...
def _typecheckingstub__bd60dad551f973eec4ba18b03eead5b07aceee826705f356cab33c000eb6599a(
    value: typing.Optional[_PagesSphinx_25bcdef0],
) -> None:
    """Type checking stubs"""
    pass
