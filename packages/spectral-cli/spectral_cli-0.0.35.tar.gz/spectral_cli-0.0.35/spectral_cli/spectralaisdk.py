    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if not api_key or reconfigure:
                ...
                new_api_key = click.prompt("Enter Spectral API key or press Enter to keep the current one. To check how to get your Spectral API key, please visit https://docs.spectral.finance/modeler-handbook/3.-submission/step-5-configure-spectral-cli#1.-obtain-spectral-api-key\n", default="", show_default=False)
                if new_api_key:
            ...
            if not alchemy_api_key or reconfigure:           
                ...
                new_alchemy_api_key = click.prompt("Enter new Alchemy API key or press Enter to keep the current one. To learn how to get your Alchemy API Key, please visit https://docs.spectral.finance/modeler-handbook/3.-submission/step-5-configure-spectral-cli#2.-obtain-alchemy-api-key\n", default="", show_default=False)
...
def fetch_testing_data(config_manager, challenge_id):
    ...
    if not ipfs_hash:
        print("The file with your challenge data is not available yet. Please try again in a couple of minutes.")
        return -1
    fetch_from_ipfs(ipfs_hash, f"{challenge_id}_testing_dataset.parquet", "Testing dataset")
