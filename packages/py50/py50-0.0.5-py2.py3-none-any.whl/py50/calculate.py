...
class Calculate:
    ...
    def calculate_data(self, name_col, concentration_col, response_col, input_units='nM'):
        name_col = name_col
        name = self.df[name_col].values
    ...
    def calculate_absolute_data(self, name_col, concentration_col, response_col, input_units='nM'):
        """
    ...
    def calculate_ic50(self, name_col, concentration_col, response_col):
        ...
        """
        # Set variables from funtion and convert name_col to np array
        values = self.calculate_data(name_col, concentration_col, response_col)
    ...
    def calculate_absolute_ic50(self, name_col, concentration_col, response_col, input_units='nM'):
        ...
        values = self.calculate_absolute_data(name_col, concentration_col, response_col, input_units=input_units)
        df = pd.DataFrame(values)
