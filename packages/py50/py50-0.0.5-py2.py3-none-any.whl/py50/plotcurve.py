...
class PlotCurve:
    ...
    def single_curve_plot(self,
        ...
        ax.scatter(concentration, response, marker=marker, color=line_color, label=drug_name)
        ax.plot(x_fit, y_fit, color=line_color, label=drug_name)
