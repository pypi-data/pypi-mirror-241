...
class UserHandler:
    ...
    def serialize(self: Self, get_branch: bool = False, get_repos: bool = False, get_repos_v2: bool = False, get_repos_v2_index: int = 1, get_achievements: bool = False, _: bool = False, repo_name: str = None, branch_name: str = None, following: bool = False, follower: bool = False, stars: bool = False, watchers: bool = False, branches_count: bool = False) -> str:
        if (get_repos):
