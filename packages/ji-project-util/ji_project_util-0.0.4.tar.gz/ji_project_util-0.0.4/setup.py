...
setuptools.setup(
    name="ji_project_util", # 项目的名字，将来通过pip install ji_project_util安装，不能与其他项目重复，否则上传失败
    version="0.0.4", # 项目版本号，自己决定吧
    author="jixiangkun", # 作者
    author_email="youngji@yeah.net", # email
    description="python项目的log工具和监控内容聚合工具",  # 项目描述
    ...
    package_data={'': ['*.yaml', '*.csv', '*.txt', '.toml']},  # 这个很重要
    classifiers=[
