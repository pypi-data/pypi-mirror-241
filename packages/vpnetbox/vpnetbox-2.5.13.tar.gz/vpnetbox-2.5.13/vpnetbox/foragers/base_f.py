...
from vpnetbox.nb_tree import NbTree, missed_urls
from vpnetbox.types_ import LDAny, DiDAny, LStr, DAny, LT2StrDAny


class BaseF:
    """Base for Forager models."""
    ...
    def count(self) -> int:
        """Count of the Netbox objects in the self data.
    ...
    def get(self, include_nested: bool = True, **kwargs) -> None:
        ...
        Request data based on the kwargs filter parameters and save the received objects
        to the NbForager root.
        :param include_nested: True - Request base and nested objects,
            False - Request only base objects.
        :param kwargs: Filter parameters.
        :return: None. Update NbForager root object.
        """
