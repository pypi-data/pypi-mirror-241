...
class TripAssumptions(BaseModel):
    ...
    feature_lifetimes: Optional[Annotated[List[FeatureLifetime], Field(min_length=0, max_length=1000)]] = Field(default=None, description="List of tag lifetimes. Affects only on compatibility Performer-Order. ")
