  ...
  private async showConsentDialogPromise(
    ...
    if (dialogShown) {
      ...
      const result = await showDialog({
        title: 'Unianalytics Consent',
        // to disable the user from clicking away or pressing ESC to cancel the Dialog box
        hasClose: false,
        body: "Enable anonymous collection of your activity with tagged notebooks to enhance teachers' ability to assess their exercise sessions?",
        buttons: [
