...
class Patcher(object):
    ...
    def auto(self, executable_path=None, force=False, version_main=None, chrome_driver_zip_path=None, _=None):
        """
        ...
        if chrome_driver_zip_path is None:
            self.unzip_package(self.fetch_package())
        else:
            self.unzip_package(chrome_driver_zip_path)
        return self.patch()
