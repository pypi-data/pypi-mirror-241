...
def stream_csv_object_to_fixed_sized_dataframes(minio_client, minio_bucket, object_name, chunk_size=5000000, df_chunk_size=1000, sep=';'):
    """
    Stream a large CSV object from Minio in chunks and concatenate them into a Pandas DataFrame.
    ...
    try:
        ...
        for offset in range(0, object_size, chunk_size):
            ...
            if len(df_chunk) > df_offset+df_chunk_size:
