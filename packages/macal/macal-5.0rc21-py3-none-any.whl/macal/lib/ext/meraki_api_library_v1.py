...
def Header(*params) -> None:
	...
	serial = params[3]
	template = params[4]
	if model is None or model ==  "nil" or model == 'NIL': model = ""
	if serial is None or serial == "nil" or serial == 'NIL': serial = ""
	if template is None or template == "nil" or template == 'NIL': template = ""
