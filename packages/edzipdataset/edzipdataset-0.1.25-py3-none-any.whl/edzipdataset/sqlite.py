...
from edzipdataset import derive_sqlite_file_path, derive_sqlite_url_from_zip_url, get_s3_credentials, get_s3fs
...
def main(s3_url:str, sqlite_filename:Optional[str] = None, endpoint_url: Optional[str] = None, key: Optional[str] = None, secret: Optional[str] = None):
    ...
    with get_s3fs(credentials).open(s3_url) as zf: # type: ignore
