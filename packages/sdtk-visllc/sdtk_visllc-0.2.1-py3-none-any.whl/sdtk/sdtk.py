    ...
    def getSource(self):
        ...
        if ((self._stage > len(self._sources)) or ((self._stage < 0))):
            ...
            try:
                input = None
                mapping = haxe_ds_StringMap()
                _g = com_sdtk_puller_Parameters.typeOfAccess(python_internal_ArrayImpl._get(self._sources, self._stage))
                if ((_g == com_sdtk_puller_Parameters.GET_GIT_HTTP) or ((_g == com_sdtk_puller_Parameters.GET_GIT_CLIENT))):
                    input = com_sdtk_api_GitAPI.instance().parse(python_internal_ArrayImpl._get(self._sources, self._stage))
                else:
                    pass
    ...
    def nextPull(self,i):
        ...
        def _hx_local_0(result):
            ...
            if ((i + 1) < len(_gthis._sources)):
                ...
                _gthis.nextPut(0)
        (self._sources[i] if i >= 0 and i < len(self._sources) else None).pull(_hx_local_0)
...
class com_sdtk_table_DataTableReader(com_sdtk_table_DataEntryReader):
    ...
    def toArrayOfObjects(self,_hx_map):
        return None
...
class com_sdtk_table_ArrayOfMapsReader(com_sdtk_table_DataTableReader):
    ...
    @staticmethod
    def readWholeArray(arr):
        return com_sdtk_table_ArrayOfMapsReader(com_sdtk_table_ArrayInfo(arr,0,(len(arr) - 1),(len(arr) - 1),1,1))
...
class com_sdtk_table_ArrayOfObjectsReader(com_sdtk_table_DataTableReader):
    ...
    @staticmethod
    def readWholeArray(arr):
        return com_sdtk_table_ArrayOfObjectsReader(com_sdtk_table_ArrayInfo(arr,0,(len(arr) - 1),(len(arr) - 1),1,1))
...
class com_sdtk_table_ObjectRowReader(com_sdtk_table_DataTableRowReader):
    ...
    def hasNext(self):
        return (self._i < len(self._fields))

    def next(self):
        self._value = Reflect.field(self._o,python_internal_ArrayImpl._get(self._fields, self._i))
        self.incrementTo(python_internal_ArrayImpl._get(self._fields, self._i),self._value,self._i)
        _hx_local_0 = self
        _hx_local_1 = _hx_local_0._i
    ...
    def iterator(self):
        return com_sdtk_table_ObjectRowReader(self._o)
    ...
    def readWholeObjectReuse(o,rowReader):
        if (rowReader is None):
            rowReader = com_sdtk_table_ObjectRowReader(o)
        else:
            rowReader.reuse(o)
        return rowReader
...
com_sdtk_puller_Parameters.GIT_TORRENT = 2
com_sdtk_puller_Parameters.GIT_BLOB = 0
com_sdtk_std_Version._code = "0.2.1"
