...
#
#     # request ke server
#     res = requests.get('https://host.com/cekNIM/' + nim)
#     valid = #parsing jsom(res)
#
#     if valid is True:
#         # isFingerValid, imFinger = True, 'tangan.jpg'
#         isFingerValid, imFinger = getFingerImageData()
#         if isFingerValid is True :
#             files = {'media': imFinger}
#             res = requests.get('https://host.com/absensi/' + nim, gambar=files)
#             cekRespon = # parsing json(res)
#
#             if cekRespon['valid']:
#                 print(absen masuk)
#             else :
