...
def chart_html(option):
    uid = uuid.uuid4().hex
    s = ['<!DOCTYPE html>',
         '<html lang="zh-CN" style="height: 100%;padding: 20px;">',
         '<head>',
         '    <meta charset="utf-8">',
         '</head>',
         '<body style="height: 100%;margin: 0;">',
         '<div id="container-uid-" style="height: calc(100% - 30px);margin-bottom: 30px;"></div>',
...
def table_list_html(table_list, table_column):
    ...
    s = ['<!DOCTYPE html>',
         ...
         '</head>',
         '<body style="height: 100%; margin: 0;">',
         '<div id="app-uid-" style="height: calc(100% - 30px);margin-bottom: 30px;">>',
         '    <el-table',
         '            :data="tableData-uid-"',
         '            border',
         '            stripe',
