...
class CSpaceSeparatingPlane_𝓣Variable𝓤:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def __copy__(self) -> CSpaceSeparatingPlane_𝓣Variable𝓤: ...
    def __deepcopy__(self, arg0: dict) -> CSpaceSeparatingPlane_𝓣Variable𝓤: ...
    @property
    def a(self) -> numpy.ndarray[object[3,1]]: ...
    @property
    def b(self) -> pydrake.symbolic.Polynomial: ...
...
class CspaceFreePolytopeBase:
    ...
    def separating_planes(self) -> List[CSpaceSeparatingPlane_𝓣Variable𝓤]: ...
...
class _TemporaryName_N5drake5ValueINS_8geometry12optimization21CSpaceSeparatingPlaneINS_8symbolic8VariableEEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: CSpaceSeparatingPlane_𝓣Variable𝓤) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> CSpaceSeparatingPlane_𝓣Variable𝓤: ...
    def get_value(self) -> CSpaceSeparatingPlane_𝓣Variable𝓤: ...
    def set_value(self, arg0: CSpaceSeparatingPlane_𝓣Variable𝓤) -> None: ...

class _TemporaryName_N5drake5ValueINS_8geometry12optimization21CSpaceSeparatingPlaneIdEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: CSpaceSeparatingPlane) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> CSpaceSeparatingPlane: ...
    def get_value(self) -> CSpaceSeparatingPlane: ...
    def set_value(self, arg0: CSpaceSeparatingPlane) -> None: ...
