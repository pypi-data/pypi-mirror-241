...
class InverseKinematics:
    ...
    def AddMinimumDistanceLowerBoundConstraint(self, bound: float, influence_distance_offset: float = ...) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
...
class MinimumDistanceLowerBoundConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, bound: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, penalty_function: Callable[[float,bool],tuple] = ..., influence_distance_offset: float = ...) -> None: ...
    @overload
...
class MinimumDistanceUpperBoundConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, bound: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, influence_distance_offset: float, penalty_function: Callable[[float,bool],tuple] = ...) -> None: ...
    @overload
