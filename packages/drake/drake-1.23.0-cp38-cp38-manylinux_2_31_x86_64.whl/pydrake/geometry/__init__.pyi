...
class SceneGraph_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_𝓣AutoDiffXd𝓤):
    ...
    def AddRenderer(self, name: str, renderer: RenderEngine) -> None: ...
    @overload
    def AddRenderer(self, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, name: str, renderer: RenderEngine) -> None: ...
    @overload
    def AddRenderer(self) -> Any: ...
    @overload
    def AssignRole(self, source_id: SourceId, geometry_id: GeometryId, properties: ProximityProperties, assign: RoleAssign = ...) -> None: ...
...
class SceneGraph_𝓣Expression𝓤(pydrake.systems.framework.LeafSystem_𝓣Expression𝓤):
    ...
    def AddRenderer(self, name: str, renderer: RenderEngine) -> None: ...
    @overload
    def AddRenderer(self, context: pydrake.systems.framework.Context_𝓣Expression𝓤, name: str, renderer: RenderEngine) -> None: ...
    @overload
    def AddRenderer(self) -> Any: ...
    @overload
    def AssignRole(self, source_id: SourceId, geometry_id: GeometryId, properties: ProximityProperties, assign: RoleAssign = ...) -> None: ...
