...
RationalForwardKinematicsPose_: pydrake.common.cpp_template.TemplateClass

class RationalForwardKinematics:
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant) -> None: ...
    def CalcBodyPoseAsMultilinearPolynomial(self, *args, **kwargs) -> Any: ...
...
class RationalForwardKinematicsPose_𝓣RationalFunction𝓤:
    ...
    def position(self) -> numpy.ndarray[object[3,1]]: ...
    def rotation(self) -> numpy.ndarray[object[3,3]]: ...
    def __copy__(self) -> RationalForwardKinematicsPose_𝓣RationalFunction𝓤: ...
    def __deepcopy__(self, arg0: dict) -> RationalForwardKinematicsPose_𝓣RationalFunction𝓤: ...
