...
HEADERS = {
        "Authorization": ts.secrets.access_secret_version("GRATA_API_TOKEN"),
        "Content-Type": "application/json",
}

def find_similar(domain: str, search: ts.models.Search) -> list:
...
def find_by_criteria(search: ts.models.Search) -> list:
    # rethink this
...
def _get_api_filter(search: ts.models.Search) -> dict:
