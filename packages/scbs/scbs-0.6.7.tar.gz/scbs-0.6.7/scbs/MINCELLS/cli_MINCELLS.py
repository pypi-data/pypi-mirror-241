...
@click.option(
    ...
    metavar="INTEGER",
    show_default=True,
    help="The minimum number of cells required to consider a genomic window for "
    "testing. For example, a value of 6 means that only windows with sequencing "
    "coverage in at least 6 cells are considered.",
)
@click.option(
    "--min-sites",
    default=3,
    ...
    metavar="INTEGER",
    show_default=True,
    help="The minimum number of methylation sites required to consider a genomic "
    "window for testing.",
)
@click.option(
    "--threads",
