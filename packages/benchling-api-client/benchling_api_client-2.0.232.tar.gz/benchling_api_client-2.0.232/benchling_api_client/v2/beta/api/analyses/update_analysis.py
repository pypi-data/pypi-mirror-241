...
) -> Optional[Union[AnalysisUpdate, ForbiddenError, NotFoundError]]:
    if response.status_code == 200:
        response_200 = AnalysisUpdate.from_dict(response.json(), strict=False)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[AnalysisUpdate, ForbiddenError, NotFoundError]]:
    return Response(
