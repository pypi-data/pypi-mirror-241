...
class Authenticate:
    def __init__(self, db_path=None, log_level='INFO', application_settings=None, account_id=None) -> object:
        ...
        self.application_settings = self._get_application_settings(account_id=account_id) if application_settings is None else application_settings
    ...
    def _init_default_db(self, force=True):
        ...
        create_statement = "CREATE TABLE \"access_tokens\" (account_id TEXT PRIMARY KEY, access_token TEXT, token_expiry TIMESTAMP, refresh_token TEXT, id_token TEXT, scopes TEXT, debug_response TEXT)"
