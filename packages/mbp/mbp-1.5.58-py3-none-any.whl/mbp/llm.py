...
__all__ = ['add_to_messages', 'encode_context', 'build_instruction', 'build_instruction_from_yaml', 'build_messages']
...
def build_messages(instruciton_with_examples, context):
    messages = []
    add_to_messages(messages, "system", instruciton_with_examples)
    add_to_messages(messages, "user", context)
