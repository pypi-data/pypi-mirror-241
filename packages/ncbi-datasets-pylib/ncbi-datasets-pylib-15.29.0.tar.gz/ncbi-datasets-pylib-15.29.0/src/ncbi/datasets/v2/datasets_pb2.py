...
_CPPTAXONOMYNODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='rank', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='primary_scientific_name', full_name='ncbi.datasets.v2.CPPTaxonomyNode.primary_scientific_name', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='primaryScientificName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
_CPPTAXONOMYNODE.fields_by_name['primary_scientific_name'].message_type = _CPPTAXONOMYNODE_NAMEANDAUTHORITY
