...
class CSSBundler:
    ...
    def init_app(self, app):
        ...
        self.add_to_bucket_url_query = app.config.get(
            "CSS_BUNDLER_ADD_TO_BUCKET_URL_QUERY", ""
        )
    ...
    def __process_bundling(self, *args, custom_paths: dict = {}):
        ...
        if self.bucket_url is not None and self.use_bucket_url is True:
            bundled_stylesheets = f"{self.bucket_url}{bundle_filename}{self.add_to_bucket_url_query}"
        else:
