...
class DataMonitor(System.Object, QuantConnect.Interfaces.IDataMonitor):
    ...
    def OnOrderEvent(self, sender: typing.Any, orderEvent: QuantConnect.Orders.OrderEvent) -> None:
        """Registers a new order event to select the trade subscriptions"""
        ...

    def SetSubscriptionManager(self, subscriptionManager: QuantConnect.Data.SubscriptionManager) -> None:
        """
        Set the SubscriptionManager instance to use to select the traded subscriptions
        
        :param subscriptionManager: The subscription manager to use
        """
        ...

    def StoreDataMonitorReport(self, report: QuantConnect.DataMonitorReport) -> None:
        """This method is protected."""
        ...

    def StoreTradedSubscriptions(self) -> None:
        """
