...
# -----------------------------------------------------------------------------
# The `SavedTextNode` class stores a matched text and its parsed tokens, 
# while `SavedText` creates such nodes upon successful parsing of a parser element.
...
class SavedTextNode:
    ...
    def __repr__(self):
        ...
        -------
        str
            The string representation of SavedTextNode.
        """
        return f"SavedTextNode({self.text}){self.tokens.__repr__()}"
...
def SavedText(node):
    """
    Constructs a parse action that creates a SavedTextNode upon successful parsing.

    Parameters
    ----------
    node : ParserElement
        The parser element to attach the SavedTextNode parse action to.

    Returns
    -------
    ParserElement
        The parser element with the SavedTextNode parse action attached.
    """
