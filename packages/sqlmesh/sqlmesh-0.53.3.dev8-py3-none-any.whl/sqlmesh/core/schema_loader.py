...
def create_schema_file(
        ...
        for dep in model.depends_on:
            if dep not in models:
                ...
                if default_catalog and external_table_name.catalog == default_catalog:
                    ...
                    external_model_names.add(normalize_model_name(external_table_name, default_catalog=None, dialect=dialect))
    ...
    if existing_model_names:
        ...
        external_model_fqns -= existing_model_names
        external_model_fqns -= {normalize_model_name(model_name, default_catalog=default_catalog, dialect=dialect) for model_name in existing_model_names}
