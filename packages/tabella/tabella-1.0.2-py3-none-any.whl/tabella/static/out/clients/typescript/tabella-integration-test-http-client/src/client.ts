...
import {Vector3, PydanticTypes, PydanticNetworkTypes, PydanticExtra, PaymentCardBrand, KineticBody, VanillaModel, RecursiveModel, Constantly, Primitives, PythonTypes, Flavor, Numbers, DefaultFactory, Defaults, CollectionsModel, ConstrainedCollections} from "./models.js";
...
export class TabellaIntegrationTestClient {

  public math: TabellaIntegrationTestMathClient;
  public auth: TabellaIntegrationTestAuthClient;
  public extra: TabellaIntegrationTestExtraClient;

  constructor(headers: object = {}) {
    transport.headers = headers;
    this.math = new TabellaIntegrationTestMathClient();
    this.auth = new TabellaIntegrationTestAuthClient();
    this.extra = new TabellaIntegrationTestExtraClient();
  }
  ...
  public async nestedModels(
    a: KineticBody  // @ts-ignore
  ): Promise<KineticBody> {}
  public async listUnionModel(
    a: Array<VanillaModel | RecursiveModel>  // @ts-ignore
  ): Promise<Array<VanillaModel | RecursiveModel>> {}
  ...
  public async pythonTypes(
    strEnum: Flavor,    numEnum: Numbers,    date: string,    time: string,    datetimeField: string,    timedelta: string,    uuidField: string,    decimal: number | string,    path: string  // @ts-ignore
  ): Promise<PythonTypes> {}
  public async default(
    a: string,    b: number,    c: number,    d: boolean,    e: boolean,    f: string[] | null,    g: DefaultFactory | null  // @ts-ignore
  ): Promise<Defaults> {}
  ...
  public async objectModel(
    a: Record<string, RecursiveModel>  // @ts-ignore
  ): Promise<Record<string, RecursiveModel>> {}
  public async objectArray(
    a: Record<string, number[]>  // @ts-ignore
...
class TabellaIntegrationTestMathClient {
...
class TabellaIntegrationTestAuthClient {
...
class TabellaIntegrationTestExtraClient {
