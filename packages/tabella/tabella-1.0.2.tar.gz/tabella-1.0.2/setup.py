...
packages = \
['tabella',
 'tabella.static.out.clients.python.tabella-integration-test-http-client',
 'tabella.static.out.clients.python.tabella-integration-test-http-client.tabella_integration_test_http_client']

package_data = \
{'': ['*'],
 'tabella': ['static/*',
             'static/out/clients/python/*',
