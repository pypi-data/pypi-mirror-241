...
class Auth0AuthToken:
    """
    Internal Class to hold the Credenital's access token and expiry time
    """
    def __init__(self):
        self.token = None
...
class Auth0DeviceAuth:
    ...
    def get_token(self) -> Auth0AuthToken:
        """
        ...
        print(f"Please visit {code_request_res['verification_uri_complete']} to complete the authenitcation process...")
