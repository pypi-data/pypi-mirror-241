...
class ConnectionConfig:
    ...
    def __init__(self, config: Any, config_path: str):
        ...
        self.user_client_id = config['userClientId']
    ...
    def _validate_config_json(config: Any, config_path: str) -> int:
        ...
        other_required_keys = ['domain', 'userClientId', 'userAudience']
        if not all(key in config for key in other_required_keys):
            raise ValueError(f'{config_path} invalid. Required keys: {other_required_keys}; got: {list(config.keys())}')
