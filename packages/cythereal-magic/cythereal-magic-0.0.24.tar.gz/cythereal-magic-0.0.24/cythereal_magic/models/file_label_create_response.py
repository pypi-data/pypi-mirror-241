...
class FileLabelCreateResponse(object):
    ...
    def __init__(self, success=None, status=None, message=None, errors=None, links=None, _self='https://api.magic.unknowncyber.com/v2/files/ce46741bf67591f5f60b7a74dec3ef8d648ca9c6', job_id=None):  # noqa: E501
