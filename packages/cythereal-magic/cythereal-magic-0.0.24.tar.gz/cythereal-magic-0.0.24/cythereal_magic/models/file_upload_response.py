...
class FileUploadResponse(object):
    ...
    def __init__(self, _self='https://api.magic.unknowncyber.com/v2/files/ce46741bf67591f5f60b7a74dec3ef8d648ca9c6', sha1=None, filename=None, filesize=None, filetype='PE32+ executable (GUI) x86-64, for MS Windows', job_id=None, message=None, mimetype=None, object_class=None, status=None):  # noqa: E501
