...
class TagResponse(object):
    ...
    def __init__(self, is_public=None, color=None, create_time=None, name=None, id=None, _self='https://api.magic.unknowncyber.com/v2/tags/643f129e9dda8351b3252ec8', username=None):  # noqa: E501
