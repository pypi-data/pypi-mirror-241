...
class VOC_SubstancesType(int, Enum):
    ...
    def __new__(cls, value, info:dict):
        ...
        obj._info = info
        obj._unit = info['unit']
        obj._formula = info['formula']
        obj._name_ = info['en']
        obj._name_en = info['en']
        obj._name_de = info['de']
        return obj
    ...
    VOCT_TOTAL = (0, {'de': 'VOCT Total', 'en': 'VOCT Total', 'formula': None, 'unit': ''})
    Formaldehyde = (1, {'de': 'Formaldehyd', 'en': 'Formaldehyde', 'formula': 'CH20, HCH0', 'unit': ''})
    BENZENE = (2, {'de': 'Benzol', 'en': 'Benzene', 'formula': 'C6H6', 'unit': ''})
    STYRENE = (3, {'de': 'Styren', 'en': 'Styrene', 'formula': 'C8H8', 'unit': ''})
    TOLUENE = (4, {'de': 'Toluol', 'en': 'Toluene', 'formula': 'IUPAC', 'unit': ''})
    TETRACHLOROETHYLENE = (5, "Tetrachloroethylene", {'de': 'Tetrachlorethen', 'en': 'Tetrachloroethylene', 'formula': 'C4CI4', 'unit': ''})
    XYLENE = (6, {'de': 'Hexan', 'en': 'Xylene', 'formula': 'C8H10', 'unit': ''})
    HEXANE  = (7, {'de': 'Styren', 'en': 'Hexane', 'formula': 'C6H14', 'unit': ''})
    OCTANE = (8, {'de': 'Octane', 'en': 'Octane', 'formula': 'C8H18', 'unit': ''})
    CYCLOPENTANE  = (9, {'de': 'Cyclopentan', 'en': 'Cyclopentane', 'formula': 'C5H10', 'unit': ''})
    METHANOL = (10, {'de': 'Methanol', 'en': 'Methanol', 'formula': 'CH3OH', 'unit': ''})
    ETHANOL = (11, {'de': 'Ethanol', 'en': 'Ethanol', 'formula': 'C2H6O', 'unit': ''})
    PENTANOL_1 = (12, {'de': '1-Pentanol', 'en': '1-Pentanol', 'formula': 'C5H12O', 'unit': ''})
    ACETONE = (13, {'de': 'Aceton', 'en': 'Acetone', 'formula': 'C3H6O', 'unit': ''})
    ETHYLENE_OXIDE = (14, {'de': 'Ethylenoxid', 'en': 'ethylene Oxide', 'formula': 'C2H4O', 'unit': ''})
    ACETALDEHYDE = (15, {'de': 'Acetaldehyd', 'en': 'Acetaldehyde ue', 'formula': 'CH3-CHO', 'unit': ''})
    ACETIC_ACID = (16, "", {'de': 'Essigsäure', 'en': 'Acetic Acid', 'formula': 'CH3COOH', 'unit': ''})
    PROPIOICE_ACID = (17, {'de': 'Propionsäure', 'en': 'Propionice Acid', 'formula': 'C3H6O2', 'unit': ''})
    VALERIC_ACID = (18, "", {'de': 'Valeriansäure', 'en': 'Valeric Acid', 'formula': 'C5H10O2', 'unit': ''})
    BUTYRIC_ACID = (19, {'de': 'Buttersäure', 'en': 'Butyric Acid', 'formula': 'C4H8O2', 'unit': ''})
    AMMONIAC = (20, "", {'de': 'Ammoniak', 'en': 'Ammoniac', 'formula': 'NH3', 'unit': ''})
    HYDROGEN_SULFIDE = (22, {'de': 'Schwefelwasserstoff', 'en': 'Hydrogen Sulfide', 'formula': 'H2S', 'unit': ''})
    DIMETHYLSULFIDE = (23, {'de': 'Dimethylsulfid', 'en': 'Dimethylsulfide', 'formula': 'C2H6S', 'unit': ''})
    BUTYL_ALCOHOL = (24, {'de': '1-Butanol', 'en': '2-Butanol (butyl Alcohol)', 'formula': 'C4H10O', 'unit': ''})
    METHYLPROPANOL_2 = (25, {'de': '2-Methyl-1-propanol', 'en': '2-Methylpropanol', 'formula': 'C4H10O', 'unit': ''})
    DIETHYL_ETHER = (26, {'de': 'Diethylether', 'en': 'Diethyl ether', 'formula': '(C2H5)2O', 'unit': ''})
    NAPHTHALENE = (27, {'de': 'Naphthalin', 'en': 'Naphthalene', 'formula': 'C10H8', 'unit': ''})
    PHENYLCYCLOHEXENE_4 = (28, {'de': '4-Phenylcyclohexene', 'en': '4-Phenylcyclohexene', 'formula': 'C12H14', 'unit': ''})
    LIMONENE = (29, {'de': 'Limonenen', 'en': 'Limonene', 'formula': 'C10H16', 'unit': ''})
    TRICHLOROETHYLENE = (30, {'de': 'Trichlorethen', 'en': 'Trichloroethylene', 'formula': 'C2HCl3', 'unit': ''})
    ISOVALERIC = (31, {'de': 'Isovaleriansäure', 'en': 'Isovaleric acid', 'formula': 'C5H10O2', 'unit': ''})
    INDOLE = (32, {'de': 'Indol', 'en': 'Indole', 'formula': 'C8H7N', 'unit': ''})
    CADAVERINE = (33, {'de': 'Cadaverin', 'en': 'Cadaverine', 'formula': 'C5H14N2', 'unit': ''})
    PUTRESCINE = (34, {'de': 'Putrescin', 'en': 'Putrescine', 'formula': 'C4H12N2', 'unit': ''})
    CAPROIC_ACID = (35, {'de': 'Capronsäure', 'en': 'Caproic acid', 'formula': 'C6H12O2', 'unit': ''})
    OZONE = (255, {'de': 'Ozon', 'en': 'Ozone', 'formula': 'O3', 'unit': ''})
