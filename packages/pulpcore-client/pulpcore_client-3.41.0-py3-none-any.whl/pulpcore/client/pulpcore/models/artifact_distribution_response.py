...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_created=None, pulp_href=None, content_guard=None, pulp_labels=None, base_url=None, base_path=None, name=None, local_vars_configuration=None):  # noqa: E501
