...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, content_guard=None, pulp_created=None, name=None, pulp_href=None, base_path=None, pulp_labels=None, hidden=False, local_vars_configuration=None):  # noqa: E501
