...
class Signals_RobotOutputSignal(rebrick.Physics.Signals_OutputSignal):
    ...
    @staticmethod
    def create(source_angle_signals, source_angular_velocity_signals, sensor_sources, source):
        r"""
        create(Physics_Signals_RealOutputSignal_Vector source_angle_signals, Physics_Signals_RealOutputSignal_Vector source_angular_velocity_signals, Physics_Signals_OutputSignal_Vector sensor_sources, std::shared_ptr< Physics::Signals::Output > source) -> std::shared_ptr< Robotics::Signals::RobotOutputSignal >
        ...
        """
        return _RoboticsSwig.Signals_RobotOutputSignal_create(source_angle_signals, source_angular_velocity_signals, sensor_sources, source)
...
def Signals_RobotOutputSignal_create(source_angle_signals, source_angular_velocity_signals, sensor_sources, source):
    r"""
    Signals_RobotOutputSignal_create(Physics_Signals_RealOutputSignal_Vector source_angle_signals, Physics_Signals_RealOutputSignal_Vector source_angular_velocity_signals, Physics_Signals_OutputSignal_Vector sensor_sources, std::shared_ptr< Physics::Signals::Output > source) -> std::shared_ptr< Robotics::Signals::RobotOutputSignal >
