...
class Signals_AccelerationValue(Signals_Vec3Value):
    r"""Proxy of C++ Physics::Signals::AccelerationValue class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(Signals_AccelerationValue self) -> Signals_AccelerationValue"""
        _PhysicsSwig.Signals_AccelerationValue_swiginit(self, _PhysicsSwig.new_Signals_AccelerationValue())

    @staticmethod
    def create(value):
        r"""
        create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::AccelerationValue >
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_create(value)

    def setDynamic(self, key, value):
        r"""
        setDynamic(Signals_AccelerationValue self, std::string const & key, Any value)
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_setDynamic(self, key, value)

    def getDynamic(self, key):
        r"""
        getDynamic(Signals_AccelerationValue self, std::string const & key) -> Any
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_getDynamic(self, key)

    def callDynamic(self, key, args):
        r"""
        callDynamic(Signals_AccelerationValue self, std::string const & key, AnyVector args) -> Any
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_callDynamic(self, key, args)

    def extractObjectFieldsTo(self, output):
        r"""
        extractObjectFieldsTo(Signals_AccelerationValue self, ObjectVector output)
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_extractObjectFieldsTo(self, output)

    def extractEntriesTo(self, output):
        r"""
        extractEntriesTo(Signals_AccelerationValue self, std::vector< std::pair< std::string,Brick::Core::Any >,std::allocator< std::pair< std::string,Brick::Core::Any > > > & output)
        ...
        """
        return _PhysicsSwig.Signals_AccelerationValue_extractEntriesTo(self, output)

    def triggerOnInit(self):
        r"""triggerOnInit(Signals_AccelerationValue self)"""
        return _PhysicsSwig.Signals_AccelerationValue_triggerOnInit(self)
    __swig_destroy__ = _PhysicsSwig.delete_Signals_AccelerationValue

# Register Signals_AccelerationValue in _PhysicsSwig:
_PhysicsSwig.Signals_AccelerationValue_swigregister(Signals_AccelerationValue)

def Signals_AccelerationValue_create(value):
    r"""
    Signals_AccelerationValue_create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::AccelerationValue >
...
class Signals_AngularAccelerationValue(Signals_Vec3Value):
    r"""Proxy of C++ Physics::Signals::AngularAccelerationValue class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(Signals_AngularAccelerationValue self) -> Signals_AngularAccelerationValue"""
        _PhysicsSwig.Signals_AngularAccelerationValue_swiginit(self, _PhysicsSwig.new_Signals_AngularAccelerationValue())

    @staticmethod
    def create(value):
        r"""
        create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::AngularAccelerationValue >
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_create(value)

    def setDynamic(self, key, value):
        r"""
        setDynamic(Signals_AngularAccelerationValue self, std::string const & key, Any value)
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_setDynamic(self, key, value)

    def getDynamic(self, key):
        r"""
        getDynamic(Signals_AngularAccelerationValue self, std::string const & key) -> Any
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_getDynamic(self, key)

    def callDynamic(self, key, args):
        r"""
        callDynamic(Signals_AngularAccelerationValue self, std::string const & key, AnyVector args) -> Any
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_callDynamic(self, key, args)

    def extractObjectFieldsTo(self, output):
        r"""
        extractObjectFieldsTo(Signals_AngularAccelerationValue self, ObjectVector output)
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_extractObjectFieldsTo(self, output)

    def extractEntriesTo(self, output):
        r"""
        extractEntriesTo(Signals_AngularAccelerationValue self, std::vector< std::pair< std::string,Brick::Core::Any >,std::allocator< std::pair< std::string,Brick::Core::Any > > > & output)
        ...
        """
        return _PhysicsSwig.Signals_AngularAccelerationValue_extractEntriesTo(self, output)

    def triggerOnInit(self):
        r"""triggerOnInit(Signals_AngularAccelerationValue self)"""
        return _PhysicsSwig.Signals_AngularAccelerationValue_triggerOnInit(self)
    __swig_destroy__ = _PhysicsSwig.delete_Signals_AngularAccelerationValue

# Register Signals_AngularAccelerationValue in _PhysicsSwig:
_PhysicsSwig.Signals_AngularAccelerationValue_swigregister(Signals_AngularAccelerationValue)

def Signals_AngularAccelerationValue_create(value):
    r"""
    Signals_AngularAccelerationValue_create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::AngularAccelerationValue >
...
class Signals_ForceValue(Signals_Vec3Value):
    ...
    def create(value):
        r"""
        create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::ForceValue >
...
def Signals_ForceValue_create(value):
    r"""
    Signals_ForceValue_create(std::shared_ptr< Math::Vec3 > value) -> std::shared_ptr< Physics::Signals::ForceValue >
...
class Physics_Signals_AccelerationValue_Vector(object):
    r"""Proxy of C++ std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        r"""iterator(Physics_Signals_AccelerationValue_Vector self) -> SwigPyIterator"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        r"""__nonzero__(Physics_Signals_AccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___nonzero__(self)

    def __bool__(self):
        r"""__bool__(Physics_Signals_AccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___bool__(self)

    def __len__(self):
        r"""__len__(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___len__(self)

    def __getslice__(self, i, j):
        r"""
        __getslice__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type j) -> Physics_Signals_AccelerationValue_Vector

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type
        j: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___getslice__(self, i, j)

    def __setslice__(self, *args):
        r"""
        __setslice__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type j)
        ...
        __setslice__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type j, Physics_Signals_AccelerationValue_Vector v)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type
        j: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type
        v: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue >,std::allocator< std::shared_ptr< Physics::Signals::AccelerationValue > > > const &

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___setslice__(self, *args)

    def __delslice__(self, i, j):
        r"""
        __delslice__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type j)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___delslice__(self, i, j)

    def __delitem__(self, *args):
        r"""
        __delitem__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type

        __delitem__(Physics_Signals_AccelerationValue_Vector self, PySliceObject * slice)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___delitem__(self, *args)

    def __getitem__(self, *args):
        r"""
        __getitem__(Physics_Signals_AccelerationValue_Vector self, PySliceObject * slice) -> Physics_Signals_AccelerationValue_Vector

        Parameters
        ----------
        slice: PySliceObject *

        __getitem__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___getitem__(self, *args)

    def __setitem__(self, *args):
        r"""
        __setitem__(Physics_Signals_AccelerationValue_Vector self, PySliceObject * slice, Physics_Signals_AccelerationValue_Vector v)
        ...
        __setitem__(Physics_Signals_AccelerationValue_Vector self, PySliceObject * slice)

        Parameters
        ----------
        slice: PySliceObject *

        __setitem__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::difference_type
        x: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector___setitem__(self, *args)

    def pop(self):
        r"""pop(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_pop(self)

    def append(self, x):
        r"""
        append(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_append(self, x)

    def empty(self):
        r"""empty(Physics_Signals_AccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_empty(self)

    def size(self):
        r"""size(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_size(self)

    def swap(self, v):
        r"""
        swap(Physics_Signals_AccelerationValue_Vector self, Physics_Signals_AccelerationValue_Vector v)

        Parameters
        ----------
        v: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > > &

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_swap(self, v)

    def begin(self):
        r"""begin(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_begin(self)

    def end(self):
        r"""end(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_end(self)

    def rbegin(self):
        r"""rbegin(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::reverse_iterator"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_rbegin(self)

    def rend(self):
        r"""rend(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::reverse_iterator"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_rend(self)

    def clear(self):
        r"""clear(Physics_Signals_AccelerationValue_Vector self)"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_clear(self)

    def get_allocator(self):
        r"""get_allocator(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::allocator_type"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_get_allocator(self)

    def pop_back(self):
        r"""pop_back(Physics_Signals_AccelerationValue_Vector self)"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_pop_back(self)

    def erase(self, *args):
        r"""
        erase(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator pos) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator

        Parameters
        ----------
        pos: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator

        erase(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator first, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator last) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator

        Parameters
        ----------
        first: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator
        last: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_erase(self, *args)

    def __init__(self, *args):
        r"""
        __init__(Physics_Signals_AccelerationValue_Vector self) -> Physics_Signals_AccelerationValue_Vector
        __init__(Physics_Signals_AccelerationValue_Vector self, Physics_Signals_AccelerationValue_Vector other) -> Physics_Signals_AccelerationValue_Vector

        Parameters
        ----------
        other: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > > const &

        __init__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type size) -> Physics_Signals_AccelerationValue_Vector

        Parameters
        ----------
        size: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type

        __init__(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type size, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & value) -> Physics_Signals_AccelerationValue_Vector

        Parameters
        ----------
        size: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type
        value: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &

        """
        _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_swiginit(self, _PhysicsSwig.new_Physics_Signals_AccelerationValue_Vector(*args))

    def push_back(self, x):
        r"""
        push_back(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_push_back(self, x)

    def front(self):
        r"""front(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_front(self)

    def back(self):
        r"""back(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_back(self)

    def assign(self, n, x):
        r"""
        assign(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type n, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)

        Parameters
        ----------
        n: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type
        x: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const &

        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_assign(self, n, x)

    def resize(self, *args):
        r"""
        resize(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type new_size)

        Parameters
        ----------
        new_size: std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type

        resize(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type new_size, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_resize(self, *args)

    def insert(self, *args):
        r"""
        insert(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator pos, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator
        ...
        insert(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::iterator pos, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type n, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_insert(self, *args)

    def reserve(self, n):
        r"""
        reserve(Physics_Signals_AccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type n)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_reserve(self, n)

    def capacity(self):
        r"""capacity(Physics_Signals_AccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AccelerationValue_Vector_capacity(self)
    __swig_destroy__ = _PhysicsSwig.delete_Physics_Signals_AccelerationValue_Vector

# Register Physics_Signals_AccelerationValue_Vector in _PhysicsSwig:
_PhysicsSwig.Physics_Signals_AccelerationValue_Vector_swigregister(Physics_Signals_AccelerationValue_Vector)
...
class Physics_Signals_AngularAccelerationValue_Vector(object):
    r"""Proxy of C++ std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        r"""iterator(Physics_Signals_AngularAccelerationValue_Vector self) -> SwigPyIterator"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        r"""__nonzero__(Physics_Signals_AngularAccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___nonzero__(self)

    def __bool__(self):
        r"""__bool__(Physics_Signals_AngularAccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___bool__(self)

    def __len__(self):
        r"""__len__(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___len__(self)

    def __getslice__(self, i, j):
        r"""
        __getslice__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type j) -> Physics_Signals_AngularAccelerationValue_Vector

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type
        j: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___getslice__(self, i, j)

    def __setslice__(self, *args):
        r"""
        __setslice__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type j)
        ...
        __setslice__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type j, Physics_Signals_AngularAccelerationValue_Vector v)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type
        j: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type
        v: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue >,std::allocator< std::shared_ptr< Physics::Signals::AngularAccelerationValue > > > const &

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___setslice__(self, *args)

    def __delslice__(self, i, j):
        r"""
        __delslice__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type j)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___delslice__(self, i, j)

    def __delitem__(self, *args):
        r"""
        __delitem__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type

        __delitem__(Physics_Signals_AngularAccelerationValue_Vector self, PySliceObject * slice)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___delitem__(self, *args)

    def __getitem__(self, *args):
        r"""
        __getitem__(Physics_Signals_AngularAccelerationValue_Vector self, PySliceObject * slice) -> Physics_Signals_AngularAccelerationValue_Vector

        Parameters
        ----------
        slice: PySliceObject *

        __getitem__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___getitem__(self, *args)

    def __setitem__(self, *args):
        r"""
        __setitem__(Physics_Signals_AngularAccelerationValue_Vector self, PySliceObject * slice, Physics_Signals_AngularAccelerationValue_Vector v)
        ...
        __setitem__(Physics_Signals_AngularAccelerationValue_Vector self, PySliceObject * slice)

        Parameters
        ----------
        slice: PySliceObject *

        __setitem__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type i, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)

        Parameters
        ----------
        i: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::difference_type
        x: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector___setitem__(self, *args)

    def pop(self):
        r"""pop(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_pop(self)

    def append(self, x):
        r"""
        append(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_append(self, x)

    def empty(self):
        r"""empty(Physics_Signals_AngularAccelerationValue_Vector self) -> bool"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_empty(self)

    def size(self):
        r"""size(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_size(self)

    def swap(self, v):
        r"""
        swap(Physics_Signals_AngularAccelerationValue_Vector self, Physics_Signals_AngularAccelerationValue_Vector v)

        Parameters
        ----------
        v: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > > &

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_swap(self, v)

    def begin(self):
        r"""begin(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_begin(self)

    def end(self):
        r"""end(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_end(self)

    def rbegin(self):
        r"""rbegin(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::reverse_iterator"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_rbegin(self)

    def rend(self):
        r"""rend(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::reverse_iterator"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_rend(self)

    def clear(self):
        r"""clear(Physics_Signals_AngularAccelerationValue_Vector self)"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_clear(self)

    def get_allocator(self):
        r"""get_allocator(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::allocator_type"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_get_allocator(self)

    def pop_back(self):
        r"""pop_back(Physics_Signals_AngularAccelerationValue_Vector self)"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_pop_back(self)

    def erase(self, *args):
        r"""
        erase(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator pos) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator

        Parameters
        ----------
        pos: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator

        erase(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator first, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator last) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator

        Parameters
        ----------
        first: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator
        last: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_erase(self, *args)

    def __init__(self, *args):
        r"""
        __init__(Physics_Signals_AngularAccelerationValue_Vector self) -> Physics_Signals_AngularAccelerationValue_Vector
        __init__(Physics_Signals_AngularAccelerationValue_Vector self, Physics_Signals_AngularAccelerationValue_Vector other) -> Physics_Signals_AngularAccelerationValue_Vector

        Parameters
        ----------
        other: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > > const &

        __init__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type size) -> Physics_Signals_AngularAccelerationValue_Vector

        Parameters
        ----------
        size: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type

        __init__(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type size, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & value) -> Physics_Signals_AngularAccelerationValue_Vector

        Parameters
        ----------
        size: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type
        value: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &

        """
        _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_swiginit(self, _PhysicsSwig.new_Physics_Signals_AngularAccelerationValue_Vector(*args))

    def push_back(self, x):
        r"""
        push_back(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_push_back(self, x)

    def front(self):
        r"""front(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_front(self)

    def back(self):
        r"""back(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_back(self)

    def assign(self, n, x):
        r"""
        assign(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type n, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)

        Parameters
        ----------
        n: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type
        x: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const &

        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_assign(self, n, x)

    def resize(self, *args):
        r"""
        resize(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type new_size)

        Parameters
        ----------
        new_size: std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type

        resize(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type new_size, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_resize(self, *args)

    def insert(self, *args):
        r"""
        insert(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator pos, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator
        ...
        insert(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::iterator pos, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type n, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::value_type const & x)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_insert(self, *args)

    def reserve(self, n):
        r"""
        reserve(Physics_Signals_AngularAccelerationValue_Vector self, std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type n)
        ...
        """
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_reserve(self, n)

    def capacity(self):
        r"""capacity(Physics_Signals_AngularAccelerationValue_Vector self) -> std::vector< std::shared_ptr< Physics::Signals::AngularAccelerationValue > >::size_type"""
        return _PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_capacity(self)
    __swig_destroy__ = _PhysicsSwig.delete_Physics_Signals_AngularAccelerationValue_Vector

# Register Physics_Signals_AngularAccelerationValue_Vector in _PhysicsSwig:
_PhysicsSwig.Physics_Signals_AngularAccelerationValue_Vector_swigregister(Physics_Signals_AngularAccelerationValue_Vector)
