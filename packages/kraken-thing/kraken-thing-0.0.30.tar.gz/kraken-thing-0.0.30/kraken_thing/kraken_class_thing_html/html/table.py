...
def table(records, header = None, thumbnail = True):
    ...
    # Build table
    table = '<div class="table-responsive"><table class="table table-sm table-responsive">' + header_text + table_rows + '</table></div>'
