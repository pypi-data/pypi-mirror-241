...
def flip(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
         ...
         undo: typing.Optional[bool] = None,
         *,
         use_flip_horizontal: typing.Optional[typing.Union[bool, typing.
                                                           Any]] = False,
         use_flip_vertical: typing.Optional[typing.Union[bool, typing.
                                                         Any]] = False):
    ''' Flip the image
    ...
    :type use_flip_horizontal: typing.Optional[typing.Union[bool, typing.Any]]
    :param use_flip_vertical: Vertical, Flip the image vertically
    :type use_flip_vertical: typing.Optional[typing.Union[bool, typing.Any]]
    '''
