...
def ask(messages, llm, vecdb_id):
    ...
    if vecdb_id == "single":
        ...
        instruction = "La base de datos de la aseguradora GNP tiene los siguientes Documentos. Usalos para responder la pregunta del final. Si no se especifica la información responde 'No lo sé.'"
        ...
        if answer == "" or "No lo sé" in answer:
