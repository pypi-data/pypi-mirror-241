...
from tsakul.csr import F32CSRMatrix, UI32CSRMatrix, csr_prep, f32csr_type
...
class DynamicDemand:
    ...
    tsakul.assignments.DynamicAssignment

    tsakul.demand.time.SimulationTime
    """
...
def build_internal_static_demand(od_graph: nx.DiGraph):
    ...
    tsakul.demand.InternalStaticDemand
...
class InternalStaticDemand(object):
    ...
    tsakul.demand.build_internal_static_demand
...
class InternalDynamicDemand(object):
    ...
    tsakul.demand.build_internal_dynamic_demand
