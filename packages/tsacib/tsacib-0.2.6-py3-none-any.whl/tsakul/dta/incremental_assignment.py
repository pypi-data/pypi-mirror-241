...
from tsakul.demand import InternalDynamicDemand, SimulationTime
from tsakul.dta.aon import get_aon_route_choice, link_to_turn_costs_deterministic
from tsakul.dta.deterministic import get_turning_fractions, update_arrival_maps
from tsakul.dta.i_ltm import i_ltm
from tsakul.dta.i_ltm_cls import ILTMState
...
def incremental_loading(
    ...
    for k in range(1, K + 1):
        ...
        # from tsakul.dta.core.debugging import plot_links_with_cost_changes
