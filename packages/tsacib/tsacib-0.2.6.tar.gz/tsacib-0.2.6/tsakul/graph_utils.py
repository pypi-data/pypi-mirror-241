...
def _make_out_links(links_to_include, from_node, to_node, tot_nodes):
    ...
    It is more efficient to work with tsakul's sparse matrices, however
...
def dijkstra_all(
    ...
    tsakul.graph_utils.pred_to_paths
...
def dijkstra_with_targets(
    ...
    `tsakul.graph_utils.dijkstra_all`
