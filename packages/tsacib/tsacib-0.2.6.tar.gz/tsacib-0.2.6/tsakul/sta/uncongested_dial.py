...
from tsakul.graph_utils import _make_in_links, _make_out_links
from tsakul.settings import parameters
from tsakul.sta.utilities import generate_bushes
from tsakul.supply import Network


# since this works with topological orders the full path set is not considered.
def sun(network: Network, demand: InternalStaticDemand, theta=parameters.static_assignment.logit_theta):
