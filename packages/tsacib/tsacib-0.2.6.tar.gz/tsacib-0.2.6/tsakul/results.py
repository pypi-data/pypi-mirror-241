...
from tsakul.graph_utils import dijkstra_all
...
def get_skim(link_costs, demand: InternalStaticDemand, network: Network):
    ...
    ----------
    link_costs: numpy.ndarray
    demand: tsakul.demand.InternalStaticDemand
    network: tsakul.supply.Network
...
def get_od_flows(assignment, result: StaticResult, return_as_matrix=False):
    ...
    Parameters
    ----------
    assignment: tsakul.assignments.StaticAssignment
    result: tsakul.results.StaticResult
