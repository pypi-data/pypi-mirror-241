...
from catrun.utils.log import logger
from catrun.core.ios.driver import IosDriver
from catrun.utils.common import calculate_time, \
    draw_red_by_rect
from catrun.utils.exceptions import KError
from catrun.core.image.element import ImgElem
from catrun.core.ocr.element import OcrElem
from catrun.utils.common import retry
...
class IosElem(object):
    ...
    def exists(self, timeout=3):
        ...
        if self._image is not None:
            return ImgElem(self._driver, file=self._image, desc=self._desc, scale=self._driver.d.scale,
    ...
    def click(self, timeout=5, watch=None):
        ...
        if self._image is not None:
            ImgElem(self._driver, file=self._image, desc=self._desc, scale=self._driver.d.scale,
