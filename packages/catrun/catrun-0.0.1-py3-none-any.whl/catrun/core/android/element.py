...
from catrun.core.android.driver import AdrDriver
...
class AdrElem(object):
    ...
    def exists(self, timeout=3):
        ...
        if self._image is not None:
            return ImgElem(self._driver, file=self._image, desc=self._desc,
    ...
    def click(self, timeout=5, watch=None):
        ...
        if self._image is not None:
            return ImgElem(self._driver, file=self._image, desc=self._desc, debug=self._debug)\
