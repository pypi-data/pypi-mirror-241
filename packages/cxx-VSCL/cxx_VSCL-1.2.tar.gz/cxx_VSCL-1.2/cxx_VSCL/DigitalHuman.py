...
class DigtalHuman():
    ...
    def set_head_action(self, action: [str]):
        """
        设置头部动作
        :param action:
        :return:
        """
        result = MyWS.do_wait_return(self.__handle_result('set_head_action', {'action': action}))
        return result['msg']

    def set_hand_action(self, action: [str]):
        """
        设置手部动作
        :param action:
        :return:
        """
        result = MyWS.do_wait_return(self.__handle_result('set_hand_action', {'action': action}))
        return result['msg']

    def set_torso_action(self, action: [str]):
        """
        设置躯干动作
        :param action:
        :return:
        """
        result = MyWS.do_wait_return(self.__handle_result('set_torso_action', {'action': action}))
        return result['msg']
