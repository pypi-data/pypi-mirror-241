...
from bigeye_sdk.generated.com.bigeye.models.generated import MetricConfiguration, MetricType, \
    ...
    MetricCreationState, LookbackType, TimeInterval, MetricParameter, NotificationChannel, Threshold, CatalogAttribute, \
    SetCatalogAttributeRequest, CatalogAttributeResponse, GetCatalogAttributeRequest, UpsertDeltaRequest, \
    Delta, UpsertDeltaResponse
            ...
            if len(tables) == 1 and len(targets) == 1:
                ...
                for t in tables:
                    if t.id == sdc.source_table_id or t.name == source_tbl:
                        source_table = t
                    elif t.id in target_ids or t.name in target_names:
                        for i, target in enumerate(targets):
