...
import numpy as np
import pytest
from npp_materialslab_tools.dic import \
    ImageDisplacementProcessorBatch
from npp_materialslab_tools.dic import DICProcessorBatch
from npp_materialslab_tools.dic._old_pydic import read_dic_file
from npp_materialslab_tools.dic import SingleImageDisplacementProcessor, DICProcessorRolling,EnumInteropolation, EnumStrainType
...
def test_single_dic_processor():
    ...
    dicpr = DICProcessorRolling(
            sidp = sidp, 
            interpolation=EnumInteropolation.RAW
            , strain_type=EnumStrainType.CAUCHY
            , scale_disp=1
            , scale_grid=1
            , rm_rigid_body_transform=True
            , save_image=False
