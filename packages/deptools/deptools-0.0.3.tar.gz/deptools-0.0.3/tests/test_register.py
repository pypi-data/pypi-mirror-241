...
from deptools.register import packages_from_files, Package, is_linux_resource, get_category, get_md5_content, get_french_name, PackageId
...
class TestRegister(unittest.TestCase):
    ...
    def test_packages_from_file(self):
        ...
        packageid = PackageId('fwupdater', 'Windows', 'x86_64')
        self.assertEqual(get_french_name(packageid), 'Utilitaire Windows pour mise à jour du micrologiciel')
        print(get_french_name(packageid))
