...
// Based on https://github.com/jupyterlab/jupyterlab/blob/3.4.x/packages/services/src/basemanager.ts
// Changes: None
// Included here because BaseManager isn't exported
// from @jupyterlab/services and is needed by ClusterTerminalManager
