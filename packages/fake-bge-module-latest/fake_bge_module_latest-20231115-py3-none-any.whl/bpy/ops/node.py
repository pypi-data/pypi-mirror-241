...
def repeat_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a repeat item to the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:341 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L341>`__
...
def repeat_zone_item_move(
    ...
    ''' Move a repeat item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:387 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L387>`__
...
def repeat_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a repeat item from the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:366 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L366>`__
...
def simulation_zone_item_move(
        ...
        *,
        direction: typing.Optional[typing.Any] = 'UP'):
    ''' Move a simulation state item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:387 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L387>`__
...
def simulation_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a state item from the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:366 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L366>`__
