...
from .CONFIG import QUERY_KW, SCORE_DISTANCE_COLUMN_NAME, VECTOR_SEARCH_MODIFIER, LABEL_SCORE_COLUMN_NAME, KEYWORDS_SCORE_COLUMN_NAME
...
class KurocoEmbedding:
    ...
    async def get_labels_score(self, 
        ...
        assert all(isinstance(x, str) for x in contexts), "Contexts must be a list or a tuple of strings"

        # Then me make the labels uniques
