...
class ArthurModel(ArthurBaseJsonDataclass):
    ...
    def get_attribute_names(self, stage: Optional[Stage] = None, value_type: Optional[ValueType] = None) -> List[str]:
        """
        Returns a list of the names of attributes for the specified stage and value type. If stage and value type
        are not supplied the function will return all attribute names.
