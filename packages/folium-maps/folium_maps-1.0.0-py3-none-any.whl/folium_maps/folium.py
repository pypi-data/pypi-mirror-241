...
from folium_maps.elements import JSCSSMixin
from folium_maps.map import FitBounds
from folium_maps.raster_layers import TileLayer
from folium_maps.utilities import (
    _parse_size,
    temp_html_filepath,
    validate_location,
    parse_options,
...
ENV = Environment(loader=PackageLoader('folium_maps', 'templates'))
...
class Map(JSCSSMixin, MacroElement):
    ...
    **kwargs
    ...
    def choropleth(self, *args, **kwargs):
        ...
        from folium_maps.features import Choropleth
