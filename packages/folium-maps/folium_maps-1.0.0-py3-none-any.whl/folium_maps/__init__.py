...
from folium_maps.features import (
    Choropleth,
    ClickForMarker,
    ColorLine,
    CustomIcon,
...
from folium_maps.raster_layers import TileLayer, WmsTileLayer
from folium_maps.vector_layers import Circle, CircleMarker, PolyLine, Polygon, Rectangle
