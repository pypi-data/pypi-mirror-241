...
from src.hubrdvmairie.models.token_ants_to_editor import TokenAntsToEditor
from src.hubrdvmairie.models.token_editor_to_ants import TokenEditorToAnts

from ..logging.app_logger import write_external_service_data
from ..services.data_validator import capitalize_custom
from ..services.mock_data import (get_mock_managed_meeting_points,
                                  get_mock_slots)
...
def init_all_editors():
    from src.hubrdvmairie.crud.crud_editor import editor as crud
    from src.hubrdvmairie.db.postgresdb import session
    editors = crud.get_all(db=session)
    editors_list = []
    if editors:
