...
class APILimitsLocal( GenericCRUD):
    ...
    def get_api_limit_by_api_type_id_external_user_id(self,api_type_id:int,external_user_id:int)->list:
        ...
        try:
           ...
           where = "api_type_id = {} AND external_user_id = {}".format(api_type_id, external_user_id)
           api_limit_result=self.select_one_tuple_by_where(view_table_name = "api_limit_view",select_clause_value=select_clause,where=where)
