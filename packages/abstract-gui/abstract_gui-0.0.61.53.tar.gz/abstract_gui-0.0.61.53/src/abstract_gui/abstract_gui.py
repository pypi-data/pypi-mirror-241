...
class SimpleGuiFunctionsManager:
    ...
    def get_function_name(self,function_name,*args):
        ...
        if function_name_found == None:
            function_name = self.get_function_name_case(function_name=function_name)
            function_name = self.get_closest_match(function_name,*args)
            if function_name:
                self.add_function_name_to_dict(function_name=function_name,original_input=original_name)
        else:
