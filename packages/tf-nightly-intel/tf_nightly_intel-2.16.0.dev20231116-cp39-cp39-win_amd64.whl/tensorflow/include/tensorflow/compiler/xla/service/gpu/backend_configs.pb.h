...
class CollectiveBackendConfig final :
 ...
 public:
  ...
  // bool no_parallel_gpu_op = 2;
  void clear_no_parallel_gpu_op();
  bool no_parallel_gpu_op() const;
  void set_no_parallel_gpu_op(bool value);
  private:
  bool _internal_no_parallel_gpu_op() const;
  void _internal_set_no_parallel_gpu_op(bool value);
  public:
...
// bool no_parallel_gpu_op = 2;
inline void CollectiveBackendConfig::clear_no_parallel_gpu_op() {
  _impl_.no_parallel_gpu_op_ = false;
}
inline bool CollectiveBackendConfig::_internal_no_parallel_gpu_op() const {
  return _impl_.no_parallel_gpu_op_;
}
inline bool CollectiveBackendConfig::no_parallel_gpu_op() const {
  // @@protoc_insertion_point(field_get:xla.gpu.CollectiveBackendConfig.no_parallel_gpu_op)
  return _internal_no_parallel_gpu_op();
}
inline void CollectiveBackendConfig::_internal_set_no_parallel_gpu_op(bool value) {
  
  _impl_.no_parallel_gpu_op_ = value;
}
inline void CollectiveBackendConfig::set_no_parallel_gpu_op(bool value) {
  _internal_set_no_parallel_gpu_op(value);
  // @@protoc_insertion_point(field_set:xla.gpu.CollectiveBackendConfig.no_parallel_gpu_op)
}
