...
from ..logging import LoggingLevel, LogMessage
from ..host.plugin_pb2 import LogField
...
class PluginBase(PluginShared):
    ...
    def log(self, log_level: LoggingLevel, message: str, fields: dict):
        ...
        for k, v in fields.items():
            msg_fields.append(LogField(key=k, value=v))

        log_message = LogMessage(log_level, message, msg_fields)
