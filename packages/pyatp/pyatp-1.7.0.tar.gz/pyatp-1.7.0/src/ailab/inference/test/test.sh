...
#     --fintuned_weights /data1/cgzhang6/ailab_sdk/src/test/ailabmodel/my_vit_patch16_50 \
#     --test_dataset_path /data1/cgzhang6/ailab_sdk/src/ailab/inference/test/images \
