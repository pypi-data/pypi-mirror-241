...
class Nigep:
    ...
    def __init__(self, execution_name: str, model: Sequential, batch_size: int, input_shape, x_data, y_data, target_names=None, class_mode='categorical', k_fold_n=5, epochs=10):
        ...
        for train_index, test_index in kf.split(self.x_data, self.y_data):
            ...
            try:
                for noise_amount in NOISE_LEVELS:
                    ...
                    model_builder.train_model_for_dataset(self.model, self.epochs, train_gen, val_gen)
