...
import time
from .test_case import TestCase, DeterministicTestCase, SimilarityTestCase, TextTestCase
...
def create_test_result(
    test_case: Union[DeterministicTestCase, TextTestCase, SimilarityTestCase],
    success: bool,
    score: float,
    metric: float,
) -> TestResult:
    ...
    elif isinstance(test_case, TextTestCase):
        return TestResult(
            success=success,
            score=score,
            metric_name=metric.__name__,
...
def run_test(
    test_cases: Union[TestCase, DeterministicTestCase, TextTestCase, SimilarityTestCase],
    metrics: List[Metric],
...
def assert_test(
    test_cases: Union[DeterministicTestCase, TextTestCase, SimilarityTestCase, List[DeterministicTestCase]],
    metrics: List[Metric],
    # max_retries: int = 1,
    # delay: int = 1,
    # min_success: int = 1,
