...
async def main():
    try:
        ...
        async def handler(event):
            ...
            nonlocal offline_user_ids
            nonlocal nonblock_user_ids
...
parser = argparse.ArgumentParser(prog='pirobot', epilog='Coded by Hk4crprasad !!!', description='Telegram Flood Control Script')
parser.add_argument('--run', '-r', action='store_true', help='Run the Telegram Account')
parser.add_argument('-piro', '--piro', action='store_true', help='Show help message')
...
if args.piro:
    ...
    print("Invalid command. Use 'pirobot -piro' for help.")
