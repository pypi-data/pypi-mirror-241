...
def setup_openai_coding_llm(interpreter):
    ...
    def coding_llm(messages):
        # Convert messages
        messages = utils.convert_to_openai_messages(messages, function_calling=True)
        ...
        for chunk in response:
            ...
            # Accumulate deltas
            accumulated_deltas = utils.merge_deltas(accumulated_deltas, delta)
            ...
            if (
                ...
                if (
                    ...
                    arguments = utils.parse_partial_json(arguments)
