...
from ..interpreters.code.create_interpreter import create_code_interpreter
from ..interpreters.code.language_map import language_map
    ...
    while True:
        ...
        try:
            ...
            for chunk in interpreter._llm(messages_for_llm):
                ...
                interpreter.messages[-1] = utils.merge_deltas(interpreter.messages[-1], chunk)
            ...
            try:
                ...
                for line in code_interpreter.run(code):
                    ...
                    if "output" in line:
                        ...
                        # Truncate output
                        output = utils.truncate_output(output, interpreter.max_output)
                    ...
                    if interpreter.vision:
                        ...
                        if "html" in line:
                            base64_image = utils.html_to_base64(line["html"])
