...
var htmlTemplate = `
    <div class="single_pair" style="padding:4px; position: relative;" id="field_panel_ID_">
        <input id="newAssetLiability_ID_key" relId="_ID_" class="field_key_value field_key" placeholder="Select Attribute" name="newAssetLiability[_ID_][key]" type="password" />
