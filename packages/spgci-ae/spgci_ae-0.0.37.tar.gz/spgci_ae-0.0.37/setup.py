...
setup(
    ...
    package_data={
        # 'spgci_ae':['*.py'],
        # 'spgci_ae.pyarmor_runtime_000000':['*.py','*.pyd'],
        # 'pyarmor_runtime_000000':['*.py','*.pyd'],
        'spgci_ae':["*"],
        'spgci_ae.pyarmor_runtime_000000':["*"],
    },
    # ext_modules=get_ext_paths('spgci_ae',EXCLUDE_FILES),
    ...
    version='0.0.37', # TODO: update version for each upload
    license='MIT',
