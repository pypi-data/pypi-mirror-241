...
def map_color(src: ImageNda, colormap: int | np.ndarray, dst: Optional[ImageNda] = None) -> ImageNda:
    """灰度图转换为彩色图"""
...
def extract_image_ir(palette: PaletteHS, im_src: ImageNda, im_dst: Optional[ImageNda] = None) -> ImageNda:
    """利用调色版从伪彩色热图中分类单通道热图"""
