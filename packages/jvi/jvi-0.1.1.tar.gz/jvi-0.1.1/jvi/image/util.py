...
from jiv.geo.size2d import absolutize_points, Size
from jiv.image.image_nda import ImageNda, new_gray, ImageNdas
...
def copy_mask(src: ImageNda, mask: ImageNda, dst: Optional[ImageNda] = None,
              bg_color: Optional[Color] = None) -> ImageNda:
    """根据mask复制"""
