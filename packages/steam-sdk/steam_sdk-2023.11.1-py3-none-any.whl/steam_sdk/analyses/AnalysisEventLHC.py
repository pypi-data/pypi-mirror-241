...
def analyze_RCD_RCO_event(settings_dictionary: dict, input_csv_file: str, flag_run_software: bool, software: str, file_counter: int):
    ...
    if input_csv_file.endswith('.csv'):
        ...
        if software == 'PSPICE':
            ...
            # copy the eventfile to the local PSPICE Folder:
            shutil.copyfile(input_csv_file,
                            os.path.join(aSTEAM_1.settings.local_PSPICE_folder, 'RCO', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
            shutil.copyfile(input_csv_file,
                            os.path.join(aSTEAM_2.settings.local_PSPICE_folder, 'RCD', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
            ...
            # copy the eventfile to the local XYCE Folder:
            shutil.copyfile(input_csv_file,
                            os.path.join(aSTEAM_1.settings.local_XYCE_folder, 'RCO', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
            shutil.copyfile(input_csv_file,
                            os.path.join(aSTEAM_2.settings.local_XYCE_folder, 'RCD', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
