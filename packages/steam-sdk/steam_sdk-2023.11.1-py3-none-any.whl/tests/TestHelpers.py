...
def assert_equal_yaml(yaml_file1, yaml_file2, check_for_same_order=False, max_relative_error=0.000001):
    """
    ...
    with open(yaml_file1, 'r') as f1, open(yaml_file2, 'r') as f2:
        ...
        if type(data1) == dict and type(data2) == dict:
            ...
            msg_list = compare_dicts_print_differences(data1, data2, max_relative_error, name1, name2, check_for_same_order)
...
## HELPERS
def compare_dicts_print_differences(dict1, dict2, max_relative_error=1e-6, name1='', name2='', check_for_same_order=False):
    """
    ...
    for key in dict1.keys():
        ...
        if is_number(dict1[key]) and is_number(dict2[key]):
            ...
            msg_list += compare_dicts_print_differences(dict1[key], dict2[key], max_relative_error, name1, name2, check_for_same_order)
