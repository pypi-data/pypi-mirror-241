...
print('SEttings:: ')
print('sync-env-settings: ENVIRONMENT: ', getattr(settings, "ENVIRONMENT"))
print('sync-env-settings: SYNC_ENV_PROJECT_NAME: ', getattr(settings, "PROJECT_NAME"))
print('sync-env-settings: SYNC_ENV_BACKUP_CONFIG: ', getattr(settings, "SYNC_ENV_BACKUP_CONFIG"))
print('sync-env-settings: SYNC_ENV_RESTORE_CONFIG: ', getattr(settings, "SYNC_ENV_RESTORE_CONFIG"))
