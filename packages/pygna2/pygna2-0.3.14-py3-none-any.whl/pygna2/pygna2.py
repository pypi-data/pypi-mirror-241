...
def _test_topology_total_degree(args):
    test_topology(args.network, args.genesets, args.output,
        ...
        results_figure_rotate_xtick=args.results_figure_rotate_xtick,
        results_figure_box_width=args.results_figure_box_width,
...
def add_results_fig_param_args(parser):
    ...
    parser.add_argument('--results-figure-rotate-xtick', metavar='<int>',
                        type=int, default=0,
                        help='Rotate x tick labels by degrees (default: 0)')
    parser.add_argument('--results-figure-box-width', metavar='<float>',
                        type=float, default=0.3,
                        help='Value between 0 and 1 for width of boxes (default: 0.3)')
    parser.add_argument('--results-figure-width', metavar='<float>',
                        type=float, default=7.0,
                        help='Width of plot in inches (default: 7)')
    parser.add_argument('--results-figure-height', metavar='<float>',
                        type=float, default=7.0,
                        help='Height of plot in inches (default: 7)')
...
def parse_arguments():
    ...
    parser_plot.add_argument('--rotate-xtick', metavar='<int>', type=int, default=0,
                        help='Rotate x tick labels by degrees (default: 0)')
    parser_plot.add_argument('--box-width', metavar='<float>', type=float, default=0.3,
                        help='Value between 0 and 1 for width of boxes (default: 0.3)')
