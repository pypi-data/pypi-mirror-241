**SHE Cryptography**
========================
The expansion of SHE is **Secure Hybrid Encryption**. It is a cryptographic system that transforms plaintext into ciphertext so that secret communication is ensured through insecure channels like the Internet. It is created by **Tahsin Ahmed**.
