...
from theutil.data import JSONFile, DataFile
from theutil.data.pathfinder import Trigger, TriggerCollection, Door, DoorCollection,\
...
class PathfinderModel(Model):
    ...
    Attributes: 
        triggers (TriggerCollection): Collection of all :class:`~theutil.data.pathfinder.Trigger` objects present in the Pathfinder simulation
        doors (DoorCollection): Collection of all :class:`~theutil.data.pathfinder.Door` objects present in the Pathfinder simulation
        groups (GroupCollection): Collection of all :class:`~theutil.data.pathfinder.Group` objects present in the Pathfinder simulation
        measurement_regions (MeasurementRegionCollection): Collection of all :class:`~theutil.data.pathfinder.MeasurementRegion` objects present in the Pathfinder simulation
        occupants (OccupantCollection): Collection of all :class:`~theutil.data.pathfinder.Occupant` objects present in the Pathfinder simulation
        rooms (RoomCollection): Collection of all :class:`~theutil.data.pathfinder.Room` objects present in the Pathfinder simulation
        targets (TargetCollection): Collection of all :class:`~theutil.data.pathfinder.Target` objects present in the Pathfinder simulation
        ...
        _summary (Optional[Summary]): Temp
    ...
    def _detect_model_files(self) -> None:
        ...
        for key, files in _known_output_files.items():
            for pair in files:
                ...
                for path in glob.glob(expected_filename_format, recursive=True):
                    try:
                    ...
                    if file_type == "json":
                        data_files_by_type.append(JSONFile(path))                        
                    else:  
                        data_files_by_type.append(DataFile(path))
    ...
    def _load_triggers(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_triggers.json" file does not exist. Trigger data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_doors(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_doors.json" file does not exist. Door data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_groups(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_groups.json" file does not exist. Group data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_measurement_regions(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_measurement-regions.json" file does not exist. Measurement Region data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_occupants(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_occupants.json" file does not exist. Occupant data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
        ...
        try:
            ...
            self._log.warn(f'The detailed Occupant output JSON files do not exist. Detailed Occupant data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_sd_accumulated.json" file does not exist. Accumulated Social Distancing data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')

        #Get Social Distancing Transient data
        try:
            sd_transient_json = self._results_data_files["social_distance_transient"]["json"][0]
        except KeyError as e:
            self._log.warn(f'The "{self.get_model_name()}_sd_transient.json" file does not exist. Transient Social Distancing data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_rooms(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_rooms.json" file does not exist. Room data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_summary(self) -> None:
        ...
        """
        try:
            summary_json: List[JSONFile] = self._results_data_files["summary"]["json"][0]
            self._summary = Summary(data=summary_json.data)
        except KeyError as e:
            self._log.warn(f'The "{self.get_model_name()}_summary.json" file does not exist. Summary data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
    ...
    def _load_targets(self) -> None:
        ...
        try:
            ...
            self._log.warn(f'The "{self.get_model_name()}_targets.json" file does not exist. Targets data will not be available for this simulation. Make sure you have enabled JSON output in Pathfinder.')
