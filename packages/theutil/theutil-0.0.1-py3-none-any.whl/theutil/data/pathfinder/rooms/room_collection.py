...
from theutil.data.pathfinder.rooms.room import Room


class RoomCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Room` objects that provides array-like interface to make accessing Room data a little easier.
