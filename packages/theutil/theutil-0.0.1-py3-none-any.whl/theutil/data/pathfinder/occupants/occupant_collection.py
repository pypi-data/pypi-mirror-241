...
from theutil.data.pathfinder.occupants.occupant import Occupant


class OccupantCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Occupant` objects that provides array-like interface to make accessing Occupant data a little easier.
