...
class MeasurementRegionCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.MeasurementRegion` objects that provides array-like interface to make accessing MeasurementRegion data a little easier.
