...
from theutil.data.pathfinder.targets import Target

class TargetCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Target` objects that provides array-like interface to make accessing Target data a little easier.
