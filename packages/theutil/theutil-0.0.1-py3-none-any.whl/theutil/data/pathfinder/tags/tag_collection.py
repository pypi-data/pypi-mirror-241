...
from theutil.data.pathfinder.tags.tag import Tag


class TagCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Tag` objects that provides array-like interface to make accessing Tag data a little easier.
