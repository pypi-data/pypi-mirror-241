...
class PathfinderModel(Model):
    ...
    Attributes: 
        triggers (TriggerCollection): Temp
        doors (DoorCollection): Temp
        groups (GroupCollection): Temp
        measurement_regions (MeasurementRegionCollection): Temp
        occupants (OccupantCollection): Temp
        rooms (RoomCollection): Temp
        targets (TargetCollection): Temp
