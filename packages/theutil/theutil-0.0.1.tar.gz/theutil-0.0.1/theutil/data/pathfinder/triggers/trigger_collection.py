...
from theutil.data.pathfinder.triggers import Trigger

class TriggerCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Trigger` objects that provides array-like interface to make accessing trigger data a little easier.
