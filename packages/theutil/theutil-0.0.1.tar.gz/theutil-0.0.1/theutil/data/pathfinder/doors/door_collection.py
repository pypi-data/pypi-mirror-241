...
from theutil.data.pathfinder.doors import Door

class DoorCollection(ADataCollection):
    """Collection of :class:`~theutil.data.pathfinder.Door` objects that provides array-like interface to make accessing Door data a little easier.
