...
class Occupant(ADataObject):
    ...
    Attributes:
        ...
        tags (TagCollection): Collection of :class:`~theutil.data.pathfinder.Tag` objects that were applied to this Occupant throughout the simulation.
...
class OccFrame(ADataObject):
    ...
    Args:
        ...
        parent (Occupant): The :class:`~theutil.data.pathfinder.Occupant` to which this frame of data applies.
...
class SocialDistanceData(ADataObject):
    ...
    Args:
        ...
        parent (Occupant): The :class:`~theutil.data.pathfinder.Occupant` to which this data applies.
