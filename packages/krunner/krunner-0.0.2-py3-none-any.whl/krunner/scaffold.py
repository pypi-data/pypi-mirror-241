...
case_content = """import krunner

from pages.adr_page import DemoPage


@krunner.story('测试demo')
class TestAdrDemo(krunner.TestCase):
    def start(self):
...
page_content = """from krunner import Page, AdrElem as Elem
