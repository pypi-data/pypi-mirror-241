...
# LONG_DESCRIPTION = 'A package that allows to encrypt and decrypt the text using the Hill Cipher technique. Checkout the repository(https://github.com/Kirandeep2806/Hill-Cipher) for codebase and snippets.'
