    ...
    for filename in sorted(allinputs):
        ...
        for j, inputDF in zip(jsonData, inputDFs):
            ...
            if input_aux is not None:
                ...
                ps = ax.plot(
                    sensor_V[1:], sensor_I[1:], label="sensor_current", markersize=2
                )
                sensor_legend = plt.legend(
                    handles=ps, loc="lower center", bbox_to_anchor=(0.99, -0.33)
                )
            ...
            if len(sigma_current) == 0:
                ...
                first_legend = plt.legend(
                    handles=p1, loc="lower center", bbox_to_anchor=(0.00, -0.33)
                )
            ...
            if len(temperature) == 0:
                ...
                second_legend = plt.legend(
                    handles=[p2], loc="lower center", bbox_to_anchor=(0.3, -0.33)
                )
            ...
            if len(humidity) == 0:
                ...
                third_legend = plt.legend(
                    handles=[p3], loc="lower center", bbox_to_anchor=(0.6, -0.33)
                )
