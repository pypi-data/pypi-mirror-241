...
Original file is located at
    https://colab.research.google.com/drive/1p2xaUrHmwps5k8HWCoOXKQXt4kVFF0Pp
"""
...
def dot_mod(A,B,Imod):
  Mul_max = A.dot(B)

  n = len(Mul_max)
  for i in range(n):
    for j in range(n):
      Mul_max[i][j] = Mul_max[i][j] % Imod
...
def Hash_23(M1,M2,IP,D,Pmod):
  print("############################################")
  print("Generate Hash 2 and Hash 3")
  V1 = IP + dot_mod(M1,D,Pmod)
  V2 = IP + dot_mod(M2,D,Pmod)
  a = random.randint(0,Pmod)
  b = random.randint(0,Pmod)
  c = random.randint(0,Pmod)
  d = random.randint(0,Pmod)
  Rt = [[a,b],[c, d]]
  Rt = np.array(Rt)
  print("Hash2 : ")
  hash2 = [dot_mod(D,Rt,Pmod), dot_mod(V1,Rt,Pmod)]
  hash3 = [dot_mod(D,Rt,Pmod), dot_mod(V2,Rt,Pmod)]
  for i in hash2:
    print(i)
  print("Hash 3 : ")
  for i in hash3:
...
def ore_test(Imod):
  print("############################################")
  print("Test")
  case1 = dot_mod(H1[0],H2[1],Imod)
  case2 = dot_mod(H1[1],H2[0],Imod)
  case3 = dot_mod(H1[0],H3[1],Imod)
  case4 = dot_mod(H1[1],H3[0],Imod)
  big = 0
  small = 0
