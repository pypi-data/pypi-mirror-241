...
def Hash_1(M, iD, P):
  ...
  R = np.array(R)
  H1 = iD + dot_mod(P,M)
  hash1 = [dot_mod(R,P), dot_mod(R,H1)]
  for i in hash1:
    print(i)
  return hash1

def Hash_23(M1,M2,IP,D):
  print("############################################")
  ...
  Rt = np.array(Rt)
  print("Hash2 : ")
  hash2 = [dot_mod(D,Rt), dot_mod(V1,Rt)]
  hash3 = [dot_mod(D,Rt), dot_mod(V2,Rt)]
  for i in hash2:
    print(i)
  print("Hash 3 : ")
  for i in hash3:
...
H1 = Hash_1(Message,IK2, K1)
tk1, tk2 = convert_token()
H2, H3 = Hash_23(tk1,tk2,IK1,K2)
ore_test()
