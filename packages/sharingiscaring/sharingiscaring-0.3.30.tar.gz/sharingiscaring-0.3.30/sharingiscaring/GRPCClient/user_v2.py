...
class NotificationServices(Enum):
    telegram = "telegram"
    email = "email"
...
class ContractNotificationPreferences(BaseModel):
    ...
    contract_update_issued: Optional[list[NotificationPreferences]] = None
...
class AccountNotificationPreferences(BaseModel):
    ...
    contract_update_issued: Optional[NotificationPreferences] = None
