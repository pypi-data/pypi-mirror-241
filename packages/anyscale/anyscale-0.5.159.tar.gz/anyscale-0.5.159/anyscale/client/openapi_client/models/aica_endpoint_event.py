...
class AicaEndpointEvent(object):
    ...
    def __init__(self, id=None, service_event_id=None, aica_endpoint_id=None, timestamp=None, event_type=None, level=None, scope=None, message=None, local_vars_configuration=None):  # noqa: E501
    ...
    def service_event_id(self, service_event_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and service_event_id is None:  # noqa: E501
            raise ValueError("Invalid value for `service_event_id`, must not be `None`")  # noqa: E501
