...
'''
	python3 status/statuses/vitals/__init__.py  "recipes/s2_tf1/_status/1_1_ingredient/STATUS_recipe_1.py"
'''
...
def check_1 ():	
	...
	vitamin_d = find_name.start ("vitamin d", recipe_struct_grove)
	

	print ('vitamin d', vitamin_d)
