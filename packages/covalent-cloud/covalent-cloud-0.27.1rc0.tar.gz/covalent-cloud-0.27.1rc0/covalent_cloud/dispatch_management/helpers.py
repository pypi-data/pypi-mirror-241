...
def associate_volume_to_executors(lat: Lattice, volume: int) -> bool:
    lat.metadata["executor_data"]["volume"] = volume
    lat.metadata["workflow_executor_data"]["volume"] = volume
    ...
    for i in tg._graph.nodes:
        ...
        metadata = tg.get_node_value(i, "metadata")
        metadata["executor_data"]["volume"] = volume
