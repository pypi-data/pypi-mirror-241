...
#        
    ...
    def new_template(self, data, doc):
        ...
        alertlogs = "  " + "\n  ".join(["https://security.microsoft.com/alerts/"+i["AlertId"] for i in self.sentinel.get_associated_alerts(str(data["incidentID"]), filter=["eDiscovery"])])
        doc.add_run(alertlogs)
