...
from midas.modules.weather import constants
...
DATA_COLS = {
    "air": [("TT_TU", constants.T_AIR, 1.0)],
    "solar": [
        ("FD_LBERG", constants.DI, JOULE_TO_WATT),
        ("FG_LBERG", constants.GHI, JOULE_TO_WATT),
    ],
    "wind": [("   F", constants.WIND, 1.0), ("   D", constants.WINDDIR, 1.0)],
    "cloud": [(" V_N", constants.CLOUDINESS, 12.5)],
    "sun": [("SD_SO", constants.SUN_HOURS, 1.0)],
    "pressure": [("   P", constants.PRESSURE, 1.0)],
}
