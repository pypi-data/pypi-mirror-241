...
class WeatherData:
    ...
    def select_hour(self, now_dt, horizon=1):
        ...
        if end_dt.year > now_dt.year:
            ...
            return [
                ...
                data1[PRESSURE].values.tolist()
                + data2[PRESSURE].values.tolist(),
            ]
    ...
    def select_block(self, now_dt, horizon=1, frame=2):
        ...
        for hour in range(horizon):
            ...
            pressures.append(self.rng.choice(data[PRESSURE].values.tolist()))
        return [t_airs, avg_t_airs, ghis, dis, winds, winddirs, pressures]
