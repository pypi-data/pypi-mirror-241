...
static PyType_Spec Mesh_spec = {"meshset.Mesh", sizeof(Mesh), 0, Py_TPFLAGS_DEFAULT, Mesh_slots};
static PyType_Spec Scene_spec = {"meshset.Scene", sizeof(Scene), 0, Py_TPFLAGS_DEFAULT, Scene_slots};
...
static PyModuleDef module_def = {PyModuleDef_HEAD_INIT, "meshset", NULL, -1, module_methods};

extern "C" PyObject * PyInit_meshset() {
