...
class loggingFormatter(logging.Formatter):
    ...
    execution_msg = "  %(name)2s  [ {filename} ]: {exec_info}: ".format(
        filename=skriba.messenger.SystemMessage.grey("%(filename)s"),
        exec_info=skriba.messenger.SystemMessage.blue_dim("%(module)s.%(funcName)s:%(lineno)2d"))
    message = "%(message)s"
