...
class PrintUtils:
    ...
    INSTALL_WELCOME_MESSAGE = (
        Style.BRIGHT
        + Fore.LIGHTBLUE_EX
        + "\n*~ Welcome to TerminalGPT-Pro installation wizard ~*\n"
        + Style.RESET_ALL
        + """
Please note that you need to have an OpenAI account to use TerminalGPT-Pro and an API key to use TerminalGPT-Pro.
...
"""
        ...
        + Fore.LIGHTBLUE_EX
        + """
Let's install the OpenAI API key, so you can use TerminalGPT-Pro.
"""
    )
...
"""
    ...
    INSTALL_SUCCESS_MESSAGE = (
        ...
        + Fore.GREEN
        + f"""
Great news! You're all set up to use TerminalGPT-Pro!

Your TerminalGPT-Pro files are all saved at {config.BASE_PATH}.
To start chatting with me, just type '{config.APP_NAME}' into your terminal and let the fun begin!

Thanks for choosing TerminalGPT-Pro - the coolest personal assistant on the block.
...
"""
    ...
    CONVERSATIONS_INIT_MESSAGE = (
        ...
        + Fore.LIGHTBLUE_EX
        + """
Welcome back to TerminalGPT-Pro!
