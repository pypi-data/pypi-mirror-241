...
def parse_idna_tables(version, table=None):
    """
    ...
    if not table:
        ...
        registry = etree.parse(table)
        gen_from = os.path.basename(table)
    ...
    print('# Generated from %s' % gen_from)
    print('')
...
def main():
    ...
    parser.add_argument('-t', '--table', type=str, default=None, help='Provide local XML IDN table')
    ...
    parse_idna_tables(args.unicode, args.table)
