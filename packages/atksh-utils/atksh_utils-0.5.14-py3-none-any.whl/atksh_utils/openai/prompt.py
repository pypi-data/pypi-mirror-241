...
```
- <The first summary title of the first page> (url: `<url of the first page>`, updated at <date w/ yyyy-mm-dd format>)
- <The second summary title of the second page> (url: `<url of the second page>`, updated at <date w/ yyyy-mm-dd format>)
<more>
- <The 10-th summary title of the last page> (url: `<url of the last page>`, updated at <date w/ yyyy-mm-dd format>)
```
