...
from .tool import _clear_session, bash, exec_python_code, get_browser_functions, pip_install
            ...
            with TPE(max_workers=mp.cpu_count()) as exe:
                ...
                for tool_call in tool_calls:
                    if tool_call.type == "function":
                        ...
                        func = next(f for f in self._functions if f.info["name"] == function_name)
                        filtered_args = {}
                        function_call_args = json.loads(function.arguments)
                ...
                for future in futures:
                    future["content"] = json.dumps(future["content"].result())
