...
- Explore all the references given by the tool `visit_page` and use them as needed.
...
#### References
- <Title of the reference 1> (url: `<url of the reference 1>`)
<more>
- <Title of the reference last> (url: `<url of the reference last>`)
