...
class OnDemandProvisioningSpecification(TypedDict, total=False):
    ...
    releases 4.8.0 and higher, excluding 5.0.x versions. On-Demand Instances
...
class InstanceFleetProvisioningSpecifications(TypedDict, total=False):
    ...
    The instance fleet configuration is available only in Amazon EMR
    releases 4.8.0 and higher, excluding 5.0.x versions. On-Demand and Spot
...
class CancelStepsInfo(TypedDict, total=False):
    ...
    Amazon EMR version 4.8.0 and higher, excluding version 5.0.0.
    """
...
class EmrApi:
    ...
    def cancel_steps(
        ...
        a ``PENDING`` or ``RUNNING`` state. In earlier versions of Amazon EMR,
    ...
    def run_job_flow(
        ...
        :param ebs_root_volume_size: The size, in GiB, of the Amazon EBS root device volume for the Linux AMI
        that each Amazon EC2 instance uses.
        ...
        :param ebs_root_volume_iops: The IOPS for the Amazon EBS root device volume for the Linux AMI that
        each Amazon EC2 instance uses.
        :param ebs_root_volume_throughput: The throughput, in MiB/s, of the Amazon EBS root device volume for the
        Linux AMI that each Amazon EC2 instance uses.
