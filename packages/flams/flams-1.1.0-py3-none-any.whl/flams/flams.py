...
from .input import parse_args, validate_input_fasta, validate_input_uniprot, validate_input_batch, get_position_in_seq
...
def flams_blast(args, fasta, amino_acid, pos, out, pwd):
    ...
    create_output(output_filename=out, amino_acid_x=amino_acid, blast_records=result)
