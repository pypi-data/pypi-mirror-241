...
def create_output(output_filename, amino_acid_x, blast_records):
    """
    ...
    _display_result(output_pre_dedupl, amino_acid_x, blast_records)
    _deduplicate_output(amino_acid_x, output_pre_dedupl, output_filename)
    os.remove(output_pre_dedupl)

def _display_result(output_filename, amino_acid_x, blast_records):
    """
        ...
        for blast_record in blast_records:
            for alignment in blast_record.alignments:
                for hsp in alignment.hsps:
                    ...
                    percentageCoverage = "{:.2%}".format((hsp.sbjct_end-hsp.sbjct_start+1)/protein_length)
