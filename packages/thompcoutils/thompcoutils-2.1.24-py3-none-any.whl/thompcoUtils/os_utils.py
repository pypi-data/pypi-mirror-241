...
def script_is_running(class_name: object) -> bool:
    """
    Checks if a python script is running
    :param class_name: the name of the python object (generally the filename without the extension)
    :return: True if running, else False
    """
    # noinspection PyTypeChecker
    script_name = inspect.getfile(object=class_name)
