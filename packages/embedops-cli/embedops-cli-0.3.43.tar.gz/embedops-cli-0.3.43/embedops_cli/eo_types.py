...
SUPPORT_EMAIL = "support@embedops.io"
...
class BadYamlFileException(EmbedOpsException):
    ...
    ERROR_FIX = (
        ...
        f"Email {SUPPORT_EMAIL} if you have questions."
    )
...
class NetworkException(EmbedOpsException):
    ...
    ERROR_FIX = (
        ...
        "For assistance, contact your account administrator or email support@embedops.io."
    )
