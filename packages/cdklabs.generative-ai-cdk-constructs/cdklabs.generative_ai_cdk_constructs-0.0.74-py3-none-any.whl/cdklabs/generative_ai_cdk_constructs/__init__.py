...
class JumpStartModel(
    ...
    def __init__(self, spec: IJumpStartModelSpec) -> None:
        '''
        :param spec: -
        ...
        jsii.create(self.__class__, self, [spec])

    @jsii.member(jsii_name="of")
    @builtins.classmethod
    def of(cls, spec: IJumpStartModelSpec) -> "JumpStartModel":
        '''
        :param spec: -
        ...
        if __debug__:
            ...
            check_type(argname="argument spec", value=spec, expected_type=type_hints["spec"])
        return typing.cast("JumpStartModel", jsii.sinvoke(cls, "of", [spec]))
