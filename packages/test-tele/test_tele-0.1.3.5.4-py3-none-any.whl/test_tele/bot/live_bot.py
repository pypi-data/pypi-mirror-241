...
async def download_command_handler(event):
    ...
    notes = """This command is used to download images from linked messages.

    Example: `/dd https://telegra.ph/Noch-s-Lunoj-12-10`

    arguments are: [link: string] [n-image: integer | optional]

    `n-image` default value is 10 (you will get 10 images that will be send as an album)
