...
class BotMessages(BaseModel):
    ...
    bot_help: str = (
        "**Usage**\n\n"
        "Command: `/dd`\n"
        "Arguments: [link] [n_image]\n\n"
        "**[n_image]**\n"
        "> Description: the number of images that will be sent to you\n"
        "> Value: Optional. Use either a number or the literal 'all'\n\n"
        "**Example**\n"
        "`/dd https://telegra.ph/Jizoku-A-Night-With-Loona-11-16 5`\n"
        "`/dd https://telegra.ph/Jizoku-A-Night-With-Loona-11-16 all`\n\n"
        "If you find a bug, want to leave feedback, or propose a collaboration, please contact @rizumiya."
    )
