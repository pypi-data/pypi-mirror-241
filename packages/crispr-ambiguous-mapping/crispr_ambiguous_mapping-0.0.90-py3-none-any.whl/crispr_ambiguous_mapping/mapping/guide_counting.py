            ...
            if not matches.empty:
                ...
                for whitelist_reporter_series in matches.iterrows(): 
                    ...
                    if contains_umi:
                        ...
                        print(whitelist_reporter_series)
                        print(tuple(whitelist_reporter_series))
                        ambiguous_accepted_umi_noncollapsed_counterdict[tuple(whitelist_reporter_series.tolist())] += sum(observed_value_counts.values())
