                    ...
                    if barcode_match_protospacer_hamming_threshold_met:  # PROTOSPACER MATCHED WHEN BARCODE IS SPECIFIED
                        ...
                        complete_match_result.protospacer_match_barcode_match = MatchSetSingleInferenceMatchResult(
                                        error=ProtospacerHammingThresholdGuideCountError(
                                            ...
                                            miscellaneous_info_dict= {
                                                "observed_barcode_sequence_encoded": observed_barcode_sequence_encoded,
                                                "observed_barcode_sequence_dists": observed_barcode_sequence_dists,
                                                "observed_barcode_sequence_dists_min": observed_barcode_sequence_dists_min,
                                                "barcode_hamming_threshold": barcode_hamming_threshold,
                                                "barcode_matches_indices": barcode_matches_indices,
                                                "whitelist_guide_reporter_df_barcode_match": whitelist_guide_reporter_df_barcode_match,
                                                "barcode_hamming_threshold_met": barcode_hamming_threshold_met,
