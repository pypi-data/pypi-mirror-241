    ...
    class SearchForRelatedConceptsView(rwdg.SearchForRelatedEntitiesView):
        ...
        def linkable_rset(self):
            ...
            return self._cw.execute(
                "DISTINCT Any O,OL,OLL ORDERBY OLL WHERE "
                + baserql
        ...
        def schema_rdef(self):
            ...
            return entity.e_schema.relation_definition(rtype, role, tetype)
        ...
        def pref_label_column(w, concept):
            w(
                tags.a(
                    SearchForRelatedConceptsView.pref_label_label(concept),
