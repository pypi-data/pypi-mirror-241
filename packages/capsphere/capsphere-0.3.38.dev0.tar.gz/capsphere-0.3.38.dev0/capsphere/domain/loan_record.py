...
class LoanRecord:
    ...
    stopping_late_fee_date: Optional[date] = None
    ...
    note_listed_at: Optional[datetime] = None
    publish_date_at: Optional[datetime] = None
    ...
    funded_noti_at: Optional[datetime] = None
    full_funded_noti_at: Optional[datetime] = None
