...
def create_trt_resource_handle(resource_name: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def create_trt_resource_handle_eager_fallback(resource_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  resource_name = _execute.make_str(resource_name, "resource_name")
  _inputs_flat = []
...
def get_calibration_data_op(resource_name: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def get_calibration_data_op_eager_fallback(resource_name: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def initialize_trt_resource(resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], max_cached_engines_count:int=1, name=None):
  r"""TODO: add doc.
...
def initialize_trt_resource_eager_fallback(resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], max_cached_engines_count: int, name, ctx):
  if max_cached_engines_count is None:
    max_cached_engines_count = 1
  max_cached_engines_count = _execute.make_int(max_cached_engines_count, "max_cached_engines_count")
...
def serialize_trt_resource(resource_name: _atypes.TensorFuzzingAnnotation[_atypes.String], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], delete_resource:bool=False, save_gpu_specific_engines:bool=True, name=None):
  r"""TODO: add doc.
...
def serialize_trt_resource_eager_fallback(resource_name: _atypes.TensorFuzzingAnnotation[_atypes.String], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], delete_resource: bool, save_gpu_specific_engines: bool, name, ctx):
  if delete_resource is None:
    delete_resource = False
  delete_resource = _execute.make_bool(delete_resource, "delete_resource")
  if save_gpu_specific_engines is None:
