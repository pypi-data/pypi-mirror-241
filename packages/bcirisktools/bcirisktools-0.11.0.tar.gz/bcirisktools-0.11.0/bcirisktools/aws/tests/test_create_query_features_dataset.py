...
from bcirisktools.aws.create_query_features_dataset import (
...
def test_create_select_features_inference(default_params):
...
def test_create_select_features_training(default_params):
    select_columns = ["col1", "col2", "col3"]
...
def test_create_select_features_fill_na(default_params):
    select_columns = ["col1", "col2", "col3"]
...
def test_get_feature_columns_from_data_catalog(mocker: MockerFixture, default_params, feature_tables):
    ...
    mocker.patch(
        "bcirisktools.aws.create_query_features_dataset.list_columns_of_table",
...
def test_get_feature_columns_feature_tables(mocker: MockerFixture, default_params, feature_tables):
    return_values = [["col1", "col2", "col3", "col4", "col5", "col6"]]
    mocker.patch(
        "bcirisktools.aws.create_query_features_dataset._get_feature_columns_from_data_catalog",
        side_effect=return_values,
    )
    params = {
        **default_params,
