...
6.1.0 (November 2023)
---------------------
* Allow direct replacement of a stage in a pipeline.

* Stages Service configurations are re-homed under the `configuration` stage attribute.

* Connection class's configuration attributes have been pythonized.

* Fixed `update_scheduled_task` method.

* Fixed recursion issue with deep-copying a stage.
