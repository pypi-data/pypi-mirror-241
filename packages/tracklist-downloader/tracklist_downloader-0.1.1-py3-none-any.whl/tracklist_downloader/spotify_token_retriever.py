...
def set_spotify_credentials_from_env():
...
def start_server(server_class=HTTPServer, handler_class=RequestHandler, port=5000):
    server_address = ('', port)
...
def get_spotify_token(timeout=30):
    ...
    set_spotify_credentials_from_env()
