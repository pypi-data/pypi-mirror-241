...
class Adw(Tk):
    def __init__(self, *args, master=None, title: str = "adw", config: bool = False, dark: bool = True,
    ...
    def dark_with_icon(self, enable: bool):
        self.dark(enable)
        self.icon_dark(enable)

    def dark(self, enable: bool):
        from sys import platform
        if platform == "win32":
            if enable:
                try:
