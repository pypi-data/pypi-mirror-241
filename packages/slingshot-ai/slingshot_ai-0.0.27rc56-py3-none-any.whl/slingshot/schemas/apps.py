...
from .mixins import ComponentEnvironmentMixin, ComponentMountsMixin, ScriptBasedComponentMixin
...
class SessionComponentSpec(ComponentEnvironmentMixin, ComponentMountsMixin, AbstractAppSpec):
