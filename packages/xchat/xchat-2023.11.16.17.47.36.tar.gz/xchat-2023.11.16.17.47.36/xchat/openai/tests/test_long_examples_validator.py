...
from xchat.openai.datalib.numpy_helper import HAS_NUMPY, NUMPY_INSTRUCTIONS
from xchat.openai.datalib.pandas_helper import HAS_PANDAS, PANDAS_INSTRUCTIONS
